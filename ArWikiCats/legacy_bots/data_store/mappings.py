"""
Centralized static mappings for category translations.

This module contains all static dictionaries used in the legacy_bots module,
providing a single source of truth for data that was previously scattered
across multiple files.
"""

# =============================================================================
# Type Table Mappings (from make_bots/bot.py)
# =============================================================================
...
# Build extended number mappings (same logic as original numbers1.py)
