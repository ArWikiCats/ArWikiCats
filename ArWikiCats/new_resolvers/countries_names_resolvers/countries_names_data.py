...
pop_of_without_in_data2 = {x: v for x, v in pop_of_without_in_data.items() if x not in formatted_data_en_ar_only}
...
len_print.data_len(
    ...
    {
        "pop_of_without_in_data2": pop_of_without_in_data2,
