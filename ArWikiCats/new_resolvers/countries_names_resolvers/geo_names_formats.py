...
from ...translations import COUNTRY_LABEL_OVERRIDES
...
geo_data: Dict[str, str] = COUNTRY_LABEL_OVERRIDES | geo_keys
...
def resolve_by_geo_names(category: str) -> str:
    ...
    logger.info_if_or_debug(f"<<yellow>> end resolve_by_geo_names: {category=}, {result=}", result)
    return result
