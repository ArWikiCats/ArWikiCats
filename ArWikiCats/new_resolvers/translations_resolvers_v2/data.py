...
country_names_and_nats_data = {
    ...
    "{en} federal election candidates": "مرشحو الانتخابات الفيدرالية {the_female}",
    ...
    "{en} general election candidates": "مرشحو الانتخابات العامة {the_female}",
    ...
    "{en} presidential candidates": "مرشحو الرئاسة {the_female}",
