...
category:yemen at 2020 fifa women's world cup
# """
...
COUNTRY_YEAR_DATA = {
    ...
    "category:{country1} at {year1} fifa world cup": "تصنيف:{country1} في كأس العالم {year1}",  # 466
    ...
    "category:candidates in {year1} {country1} elections": "تصنيف:مرشحون في انتخابات {country1} في {year1}",  # 73
    ...
    "category:{country1} at {year1} copa américa": "تصنيف:{country1} في كوبا أمريكا {year1}",  # 57
    "category:{year1} in colony of {country1}": "تصنيف:{country1} في {year1}",  # 54
