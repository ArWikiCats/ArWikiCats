...
all imports of (get_and_label|apply_pattern_replacements|match_sport_key|get_from_new_p17_final|get_from_pf_keys2) should be changed from `translations` into `translations.funcs`
