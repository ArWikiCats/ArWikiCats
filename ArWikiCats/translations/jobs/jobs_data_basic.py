...
len_print.data_len(
    "jobs_data_basic.py",
    {
        "MEN_WOMENS_JOBS_2": len(MEN_WOMENS_JOBS_2),
        "MILITARY_PREFIXES": len(MILITARY_PREFIXES),
        "MILITARY_ROLE_LABELS": len(MILITARY_ROLE_LABELS),
        "PAINTER_CATEGORY_LABELS": len(PAINTER_CATEGORY_LABELS),
        "PAINTER_ROLE_LABELS": len(PAINTER_ROLE_LABELS),
        "PAINTER_STYLES": len(PAINTER_STYLES),
        "RELIGIOUS_KEYS_PP": len(RELIGIOUS_KEYS_PP),
        "NAT_BEFORE_OCC": len(NAT_BEFORE_OCC),
    },
)
