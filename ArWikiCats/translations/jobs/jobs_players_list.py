...
len_print.data_len(
    ...
    {
        "PLAYERS_TO_MEN_WOMENS_JOBS": len(PLAYERS_TO_MEN_WOMENS_JOBS),  # 1,345
        "SPORT_JOB_VARIANTS": len(SPORT_JOB_VARIANTS),  # 61,919
        "BASE_PLAYER_VARIANTS": len(BASE_PLAYER_VARIANTS),  # 435
        "GENERAL_SCOPE_LABELS": len(GENERAL_SCOPE_LABELS),  # 9
        "STATIC_PLAYER_LABELS": len(STATIC_PLAYER_LABELS),  # 4
        "BOXING_LABELS": len(BOXING_LABELS),  # 42
        "TEAM_SPORT_LABELS": len(TEAM_SPORT_LABELS),  # 31
        "SKATING_LABELS": len(SKATING_LABELS),  # 4
        "FOOTBALL_KEYS_PLAYERS": len(FOOTBALL_KEYS_PLAYERS),  # 46
        "JOBS_PLAYERS": len(JOBS_PLAYERS),  # 145
    },
)
