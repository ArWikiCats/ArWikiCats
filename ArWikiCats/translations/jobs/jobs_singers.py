...
len_print.data_len(
    "jobs_singers.py",
    {
        "MEN_WOMENS_SINGERS_BASED": len(MEN_WOMENS_SINGERS_BASED),
        "FILMS_TYPE": len(FILMS_TYPE),
        "NON_FICTION_BASE_TOPICS": len(NON_FICTION_BASE_TOPICS),
        "NON_FICTION_TOPICS": len(NON_FICTION_TOPICS),
        "SINGER_CATEGORY_LABELS": len(SINGER_CATEGORY_LABELS),
        "SINGERS_AFTER_ROLES": len(SINGERS_AFTER_ROLES),
        "MEN_WOMENS_SINGERS": len(MEN_WOMENS_SINGERS),
        "SINGERS_TAB": len(SINGERS_TAB),
    },
)
