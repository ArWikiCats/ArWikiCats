...
len_print.data_len(
    "nationality.py",
    {
        "raw_nats_as_en_key": len(raw_nats_as_en_key),
        "ar_Nat_men": len(ar_Nat_men),
        "Nat_men": len(Nat_men),
        "Nat_mens": len(Nat_mens),
        "Nat_women": len(Nat_women),
        "Nat_Womens": len(Nat_Womens),
        "all_country_ar": len(all_country_ar),
        "countries_from_nat": len(countries_from_nat),
        "All_Nat": len(All_Nat),
        "all_country_with_nat_ar": len(all_country_with_nat_ar),
        "all_country_with_nat": len(all_country_with_nat),
        "American_nat": len(American_nat),
        "countries_nat_en_key": len(countries_nat_en_key),
        "en_nats_to_ar_label": len(en_nats_to_ar_label),
        "Nat_the_male": len(Nat_the_male),
        "Nat_the_female": len(Nat_the_female),
    },
)
