...
len_print.data_len(
    "Sport_key.py",
    {
        "SPORT_KEY_RECORDS": len(SPORT_KEY_RECORDS),
        "SPORT_KEY_RECORDS_BASE": len(SPORT_KEY_RECORDS_BASE),
        "SPORT_KEY_RECORDS_VARIANTS": len(SPORT_KEY_RECORDS_VARIANTS),
        "SPORTS_KEYS_FOR_LABEL": len(SPORTS_KEYS_FOR_LABEL),
        "SPORTS_KEYS_FOR_JOBS": len(SPORTS_KEYS_FOR_JOBS),
        "SPORTS_KEYS_FOR_TEAM": len(SPORTS_KEYS_FOR_TEAM),
    },
)
