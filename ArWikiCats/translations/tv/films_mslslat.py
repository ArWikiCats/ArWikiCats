...
len_print.data_len(
    "films_mslslat.py",
    {
        "Films_key_For_nat_extended": len(Films_key_For_nat_extended),
        "TELEVISION_KEYS": len(TELEVISION_KEYS),
        "Films_key_For_nat": len(Films_key_For_nat),
        "films_mslslat_tab": len(films_mslslat_tab),
        "films_key_cao2": len(films_key_cao2),
        "Films_key_CAO": len(Films_key_CAO),
        "Films_keys_both_new_female": len(Films_keys_both_new_female),
        "film_keys_for_female": len(film_keys_for_female),
        "film_keys_for_male": len(film_keys_for_male),
        "Films_key_man": len(Films_key_man),
        # "films_key_for_nat_extended_org": len(films_key_for_nat_extended_org),
        # "films_mslslat_tab_base_org": len(films_mslslat_tab_base_org),
    },
)
