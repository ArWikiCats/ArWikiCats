...
-   [13. أكواد غير مستخدمة حالياً](#13-أكواد-غير-مستخدمة-حالياً)
...
## 13.1 محلل الوظائف الزمنية (Year-Job Resolver)
...
## 13.2 محلل الوظائف الزمنية مع المنشأ (Year-Job-Origin Resolver)
...
**ملاحظة:** هذه المحللات جاهزة للاستخدام لكنها تتطلب اختبارًا إضافيًا قبل دمجها في سير العمل الرئيسي.
