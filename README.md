...
## 13.4 محلل الجنسيات مع التصنيف حسب الجنس (Gender-Aware Nationality Resolver)
...
| نوع التصنيف    | الأسلوب القديم (ضعيف)          | الأسلوب الجديد (محسّن)        |
| -------------- | ------------------------------ | ----------------------------- |
...
| التصنيف الإنجليزي                     | الترجمة المحسّنة              |
| ------------------------------------- | ----------------------------- |
...
**ملاحظة:** هذا المحلل جاهز للاستخدام ولكنه غير مدمج في سير العمل الرئيسي حاليًا.
