...
with open(Path(__file__).parent / "jobs_data_multi_one_word.json", "w", encoding="utf-8") as f:
...
with open(Path(__file__).parent / "jobs_data_multi_two_words.json", "w", encoding="utf-8") as f:
    json.dump(new_data, f, ensure_ascii=False, indent=4)
