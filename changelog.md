...
## [Add comprehensive Arabic README documentation] - 2025-11-20

- Added:
  - README شامل يشرح هدف المشروع، آلية العمل، التثبيت، الاستخدام، وخريطة الملفات باللغة العربية.
- Changed:
  - توجيه المستخدمين لتشغيل الاختبارات بعد أي تحديث للبيانات أو القواعد لضمان ثبات المخرجات.
