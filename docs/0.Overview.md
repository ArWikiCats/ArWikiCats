...
* Installation and basic usage: see [Getting Started](/ArWikiCats/ArWikiCats/2-getting-started)
* Detailed architecture: see [Architecture](/ArWikiCats/ArWikiCats/3-architecture)
* Translation data organization: see [Translation Data](/ArWikiCats/ArWikiCats/4-translation-data)
* Resolver implementations: see [Resolver System](/ArWikiCats/ArWikiCats/5-resolver-system)
* Template formatting engine: see [Formatting System](/ArWikiCats/ArWikiCats/6-formatting-system)
...
1. **Public API Layer** - User-facing functions in [ArWikiCats/\\_\\_init\\_\\_.py](https://github.com/ArWikiCats/ArWikiCats/blob/4095f04e/ArWikiCats/\\_\\_init\\_\\_.py)  that provide simple interfaces for single-category and batch translation
...
All public API functions are exported from [ArWikiCats/ L1-L40](https://github.com/ArWikiCats/ArWikiCats/blob/4095f04e/ArWikiCats/\\_\\_init\\_\\_.py#L1-L40)
...
Resolvers are ordered to prevent semantic conflicts. For example, "football manager" must be resolved by the jobs resolver (as an occupation) before the sports resolver can interpret it as a sports management role. The priority order is explicitly documented in [new_resolvers/ L29-L57](https://github.com/ArWikiCats/ArWikiCats/blob/4095f04e/new_resolvers/\\_\\_init\\_\\_.py#L29-L57)
