...
**Sources:** [README.md L1-L560](../README.md#L1-L560)

 [CLAUDE.md L1-L227](../CLAUDE.md#L1-L227)

 [.github/copilot-instructions.md L1-L121](../.github/copilot-instructions.md#L1-L121)
...
**Sources:** [README.md L42-L113](../README.md#L42-L113)

 [changelog.md L1-L80](../changelog.md#L1-L80)
...
**Sources:** [ArWikiCats/main_processers/main_resolve.py L1-L106](../ArWikiCats/main_processers/main_resolve.py#L1-L106)
 ...
 [CLAUDE.md L69-L103](../CLAUDE.md#L69-L103)
...
**Sources:** [ArWikiCats/main_processers/main_resolve.py L32-L94](../ArWikiCats/main_processers/main_resolve.py#L32-L94)
...
**Sources:** [README.md L333-L430](../README.md#L333-L430)

 [CLAUDE.md L199-L220](../CLAUDE.md#L199-L220)
...
All public API functions are exported from [ArWikiCats/ L1-L40](../ArWikiCats/__init__.py#L1-L40)

 and documented in the package's top-level module.

**Sources:** [README.md L170-L230](../README.md#L170-L230)

 [ArWikiCats/main_processers/main_resolve.py L33-L100](../ArWikiCats/main_processers/main_resolve.py#L33-L100)
...
**Sources:** [README.md L89-L113](../README.md#L89-L113)

 [changelog.md L247-L294](../changelog.md#L247-L294)
...
Resolvers are ordered to prevent semantic conflicts. For example, "football manager" must be resolved by the jobs resolver (as an occupation) before the sports resolver can interpret it as a sports management role. The priority order is explicitly documented in [new_resolvers/ L29-L57](../new_resolvers/__init__.py#L29-L57)
...
**Sources:** [changelog.md L170-L200](../changelog.md#L170-L200)
 ...
 [CLAUDE.md L139-L143](../CLAUDE.md#L139-L143)

 [README.md L434-L508](../README.md#L434-L508)
