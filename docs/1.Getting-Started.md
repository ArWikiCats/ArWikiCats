...
For an architectural overview of how the translation system works internally, see [Architecture](/ArWikiCats/ArWikiCats/3-architecture). For details on the translation data structure, see [Translation Data](/ArWikiCats/ArWikiCats/4-translation-data).
...
**Sources:** [README.md L1-L7](https://github.com/ArWikiCats/ArWikiCats/blob/4095f04e/README.md#L1-L7)

 [pyproject.toml](https://github.com/ArWikiCats/ArWikiCats/blob/4095f04e/pyproject.toml)
...
**Sources:** [README.md L149-L167](https://github.com/ArWikiCats/ArWikiCats/blob/4095f04e/README.md#L149-L167)
...
3. Applies the appropriate resolver ([ArWikiCats/new_resolvers/sports_resolvers/](https://github.com/ArWikiCats/ArWikiCats/blob/4095f04e/ArWikiCats/new_resolvers/sports_resolvers/) )
4. Formats the Arabic output with proper grammar
5. Adds the `تصنيف:` prefix

**Sources:** [README.md L174-L180](https://github.com/ArWikiCats/ArWikiCats/blob/4095f04e/README.md#L174-L180)

 [examples/run.py L1-L48](https://github.com/ArWikiCats/ArWikiCats/blob/4095f04e/examples/run.py#L1-L48)
...
All four functions ultimately call `main_resolve()` from [ArWikiCats/main_processers/main_resolve.py](https://github.com/ArWikiCats/ArWikiCats/blob/4095f04e/ArWikiCats/main_processers/main_resolve.py)

 which orchestrates the resolver chain.

**Sources:** [ArWikiCats/__init__.py L1-L50](https://github.com/ArWikiCats/ArWikiCats/blob/4095f04e/ArWikiCats/__init__.py#L1-L50)

 [ArWikiCats/event_processing.py L1-L100](https://github.com/ArWikiCats/ArWikiCats/blob/4095f04e/ArWikiCats/event_processing.py#L1-L100)

 [ArWikiCats/main_processers/main_resolve.py L1-L100](https://github.com/ArWikiCats/ArWikiCats/blob/4095f04e/ArWikiCats/main_processers/main_resolve.py#L1-L100)
...
This function calls `main_resolve()` directly from [ArWikiCats/main_processers/main_resolve.py L1-L50](https://github.com/ArWikiCats/ArWikiCats/blob/4095f04e/ArWikiCats/main_processers/main_resolve.py#L1-L50)

 and returns the raw Arabic label.

**Sources:** [README.md L206-L214](https://github.com/ArWikiCats/ArWikiCats/blob/4095f04e/README.md#L206-L214)

 [ArWikiCats/main_processers/main_resolve.py L1-L50](https://github.com/ArWikiCats/ArWikiCats/blob/4095f04e/ArWikiCats/main_processers/main_resolve.py#L1-L50)
...
This function uses `EventProcessor` from [ArWikiCats/event_processing.py L1-L200](https://github.com/ArWikiCats/ArWikiCats/blob/4095f04e/ArWikiCats/event_processing.py#L1-L200)
...
**Sources:** [README.md L174-L180](https://github.com/ArWikiCats/ArWikiCats/blob/4095f04e/README.md#L174-L180)
 ...
 [ArWikiCats/event_processing.py L1-L200](https://github.com/ArWikiCats/ArWikiCats/blob/4095f04e/ArWikiCats/event_processing.py#L1-L200)
...
**Sources:** [README.md L184-L204](https://github.com/ArWikiCats/ArWikiCats/blob/4095f04e/README.md#L184-L204)
...
**Sources:** [README.md L216-L229](https://github.com/ArWikiCats/ArWikiCats/blob/4095f04e/README.md#L216-L229)
...
1. **Normalization** - `change_cat()` from [ArWikiCats/format_bots/__init__.py](https://github.com/ArWikiCats/ArWikiCats/blob/4095f04e/ArWikiCats/format_bots/__init__.py)  strips prefixes and normalizes spacing
2. **Main Resolution** - `main_resolve()` from [ArWikiCats/main_processers/main_resolve.py L29-L57](https://github.com/ArWikiCats/ArWikiCats/blob/4095f04e/ArWikiCats/main_processers/main_resolve.py#L29-L57)  orchestrates the resolver chain
3. **Time Detection** - `LabsYears.return_text()` from [ArWikiCats/time_formats/labs_years.py](https://github.com/ArWikiCats/ArWikiCats/blob/4095f04e/ArWikiCats/time_formats/labs_years.py)  checks for year patterns first
4. **Specialized Resolvers** - `all_new_resolvers()` from [ArWikiCats/new_resolvers/__init__.py L29-L57](https://github.com/ArWikiCats/ArWikiCats/blob/4095f04e/ArWikiCats/new_resolvers/__init__.py#L29-L57)  tries jobs → sports → nationalities → countries in order
5. **Legacy Fallback** - `legacy_resolvers()` from [ArWikiCats/legacy_bots/__init__.py L66-L97](https://github.com/ArWikiCats/ArWikiCats/blob/4095f04e/ArWikiCats/legacy_bots/__init__.py#L66-L97)  handles remaining patterns
6. **Post-Processing** - `fixlabel()` from [ArWikiCats/fix/fixtitle.py](https://github.com/ArWikiCats/ArWikiCats/blob/4095f04e/ArWikiCats/fix/fixtitle.py)  applies Arabic grammar rules
7. **Prefix Addition** - `EventProcessor._prefix_label()` from [ArWikiCats/event_processing.py](https://github.com/ArWikiCats/ArWikiCats/blob/4095f04e/ArWikiCats/event_processing.py)  adds `تصنيف:`
...
**Sources:** [ArWikiCats/main_processers/main_resolve.py L1-L100](https://github.com/ArWikiCats/ArWikiCats/blob/4095f04e/ArWikiCats/main_processers/main_resolve.py#L1-L100)

 [ArWikiCats/new_resolvers/__init__.py L29-L57](https://github.com/ArWikiCats/ArWikiCats/blob/4095f04e/ArWikiCats/new_resolvers/__init__.py#L29-L57)

 [ArWikiCats/legacy_bots/__init__.py L66-L97](https://github.com/ArWikiCats/ArWikiCats/blob/4095f04e/ArWikiCats/legacy_bots/__init__.py#L66-L97)

 [ArWikiCats/fix/fixtitle.py](https://github.com/ArWikiCats/ArWikiCats/blob/4095f04e/ArWikiCats/fix/fixtitle.py)

 [ArWikiCats/event_processing.py L1-L150](https://github.com/ArWikiCats/ArWikiCats/blob/4095f04e/ArWikiCats/event_processing.py#L1-L150)
...
**Sources:** [examples/run.py L1-L48](https://github.com/ArWikiCats/ArWikiCats/blob/4095f04e/examples/run.py#L1-L48)
...
**Sources:** [examples/run.py L1-L48](https://github.com/ArWikiCats/ArWikiCats/blob/4095f04e/examples/run.py#L1-L48)
 ...
 [examples/5k.py L1-L50](https://github.com/ArWikiCats/ArWikiCats/blob/4095f04e/examples/5k.py#L1-L50)

 [README.md L233-L239](https://github.com/ArWikiCats/ArWikiCats/blob/4095f04e/README.md#L233-L239)

---

## Configuration

ArWikiCats supports configuration via environment variables. Configuration is loaded by [ArWikiCats/config.py L1-L52](https://github.com/ArWikiCats/ArWikiCats/blob/4095f04e/ArWikiCats/config.py#L1-L52)
...
The configuration uses a dataclass-based structure from [ArWikiCats/config.py L19-L46](https://github.com/ArWikiCats/ArWikiCats/blob/4095f04e/ArWikiCats/config.py#L19-L46)
...
**Sources:** [README.md L170-L239](https://github.com/ArWikiCats/ArWikiCats/blob/4095f04e/README.md#L170-L239)

 [examples/run.py](https://github.com/ArWikiCats/ArWikiCats/blob/4095f04e/examples/run.py)

 [examples/5k.py](https://github.com/ArWikiCats/ArWikiCats/blob/4095f04e/examples/5k.py)
...
* **Explore the architecture**: See [Architecture](/ArWikiCats/ArWikiCats/3-architecture) to understand how the resolver chain works
* **Learn about translation data**: See [Translation Data](/ArWikiCats/ArWikiCats/4-translation-data) for details on the 33,691+ translation entries
* **Understand the resolver chain**: See [Resolver Chain](/ArWikiCats/ArWikiCats/5-resolver-system) for how patterns are matched
* **Add custom translations**: See [Development Guide](/ArWikiCats/ArWikiCats/9-development-guide) for extending the system

For production usage and performance tuning, consult the [Resolver Chain](/ArWikiCats/ArWikiCats/5-resolver-system) documentation to understand which patterns are prioritized and how to optimize for your specific use cases.

**Sources:** [README.md L27-L28](https://github.com/ArWikiCats/ArWikiCats/blob/4095f04e/README.md#L27-L28)
