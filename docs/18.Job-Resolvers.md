...
For nationality-based category resolution without job components, see [Nationality Resolvers](/ArWikiCats/ArWikiCats/5.2-nationality-resolvers). For sports-specific categories that don't involve occupations, see [Sports Resolvers](/ArWikiCats/ArWikiCats/5.5-sports-resolvers). For the overall resolver chain orchestration, see [Resolver Chain](/ArWikiCats/ArWikiCats/5-resolver-system).
