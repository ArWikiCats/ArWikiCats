...
**Sources:** [_work_files/data_len.json L54-L117](https://github.com/ArWikiCats/ArWikiCats/blob/4095f04e/_work_files/data_len.json#L54-L117)
...
subgraph subGraph2 ["Gendered and Specialized"]
    FEMALE
    CHAMP
    WORLD
    VARIANTS
...
subgraph subGraph0 ["Sport Translation Data"]
    BASE
    TEAMS
    GAMES
end
...
**Sources:** [ArWikiCats/translations/__init__.py L56-L78](https://github.com/ArWikiCats/ArWikiCats/blob/4095f04e/ArWikiCats/translations/__init__.py#L56-L78)

 [_work_files/data_len.json L54-L90](https://github.com/ArWikiCats/ArWikiCats/blob/4095f04e/_work_files/data_len.json#L54-L90)
...
subgraph subGraph0 ["Sport Resolution Strategies"]
    TEAM_RES
    PLAYER_RES
    OLYMPIC_RES
    GENERAL_RES
...
**Sources:** [ArWikiCats/translations/utils/match_sport_keys.py](https://github.com/ArWikiCats/ArWikiCats/blob/4095f04e/ArWikiCats/translations/utils/match_sport_keys.py)

 [ArWikiCats/translations/__init__.py L77-L78](https://github.com/ArWikiCats/ArWikiCats/blob/4095f04e/ArWikiCats/translations/__init__.py#L77-L78)
...
subgraph subGraph0 ["Match Result"]
    FOUND
end
```
...
**Sources:** [ArWikiCats/translations/utils/match_sport_keys.py](https://github.com/ArWikiCats/ArWikiCats/blob/4095f04e/ArWikiCats/translations/utils/match_sport_keys.py)
 ...
 [changelog.md L205](https://github.com/ArWikiCats/ArWikiCats/blob/4095f04e/changelog.md#L205-L205)
...
**Sources:** [_work_files/data_len.json L7](https://github.com/ArWikiCats/ArWikiCats/blob/4095f04e/_work_files/data_len.json#L7-L7)
 ...
 [changelog.md L205-L207](https://github.com/ArWikiCats/ArWikiCats/blob/4095f04e/changelog.md#L205-L207)

 [tests/event_lists/test_defunct.py L12-L65](https://github.com/ArWikiCats/ArWikiCats/blob/4095f04e/tests/event_lists/test_defunct.py#L12-L65)
...
**Sources:** [_work_files/data_len.json L60-L62](https://github.com/ArWikiCats/ArWikiCats/blob/4095f04e/_work_files/data_len.json#L60-L62)

 [_work_files/data_len.json L113-L114](https://github.com/ArWikiCats/ArWikiCats/blob/4095f04e/_work_files/data_len.json#L113-L114)
...
**Sources:** [_work_files/data_len.json L58](https://github.com/ArWikiCats/ArWikiCats/blob/4095f04e/_work_files/data_len.json#L58-L58)

 [changelog.md L239-L241](https://github.com/ArWikiCats/ArWikiCats/blob/4095f04e/changelog.md#L239-L241)

 [tests/event_lists/test_defunct.py L62-L65](https://github.com/ArWikiCats/ArWikiCats/blob/4095f04e/tests/event_lists/test_defunct.py#L62-L65)
...
**Sources:** [changelog.md L263-L271](https://github.com/ArWikiCats/ArWikiCats/blob/4095f04e/changelog.md#L263-L271)

 [changelog.md L290-L303](https://github.com/ArWikiCats/ArWikiCats/blob/4095f04e/changelog.md#L290-L303)
...
**Sources:** [changelog.md L205](https://github.com/ArWikiCats/ArWikiCats/blob/4095f04e/changelog.md#L205-L205)

 [ArWikiCats/translations_formats/](https://github.com/ArWikiCats/ArWikiCats/blob/4095f04e/ArWikiCats/translations_formats/)
...
SPORT_EN["{sport}<br>English sport name"]
SPORT_LABEL["{sport_label}<br>Sport label variant"]
SPORT_JOBS["{sport_jobs}<br>Sport job context"]
OUTPUT_PH["Arabic Replacements"]
SPORT_AR["{sport_ar}<br>Arabic sport name"]
SPORT_AR_LABEL["{sport_ar_label}<br>Arabic label variant"]
SPORT_AR_JOBS["{sport_ar_jobs}<br>Arabic job variant"]

subgraph subGraph0 ["Placeholder System"]
    INPUT_PH
    SPORT_EN
    SPORT_LABEL
    SPORT_JOBS
    ...
    SPORT_AR_JOBS
    INPUT_PH --> SPORT_EN
    INPUT_PH --> SPORT_LABEL
    INPUT_PH --> SPORT_JOBS
    OUTPUT_PH --> SPORT_AR
    OUTPUT_PH --> SPORT_AR_LABEL
    OUTPUT_PH --> SPORT_AR_JOBS
    SPORT_EN --> SPORT_AR
...
**Sources:** [changelog.md L23-L49](https://github.com/ArWikiCats/ArWikiCats/blob/4095f04e/changelog.md#L23-L49)
...
**Sources:** [changelog.md L205-L303](https://github.com/ArWikiCats/ArWikiCats/blob/4095f04e/changelog.md#L205-L303)
