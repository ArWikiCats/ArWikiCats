...
For information about how formatters are used within resolvers, see [Resolver Chain](/ArWikiCats/ArWikiCats/5-resolver-system). For details on translation data organization, see [Translation Data](/ArWikiCats/ArWikiCats/4-translation-data).
...
Sources: [ArWikiCats/translations_formats/__init__.py L1-L48](https://github.com/ArWikiCats/ArWikiCats/blob/4095f04e/ArWikiCats/translations_formats/__init__.py#L1-L48)
 ...
 [ArWikiCats/translations_formats/DataModel/model_data_base.py L1-L29](https://github.com/ArWikiCats/ArWikiCats/blob/4095f04e/ArWikiCats/translations_formats/DataModel/model_data_base.py#L1-L29)
...
subgraph subGraph4 ["Helper Classes"]
    HELPERS
    RESULT
    RESULT --> HELPERS
end
...
subgraph subGraph0 ["Abstract Base"]
    BASE
end
```

Sources: [ArWikiCats/translations_formats/DataModel/__init__.py L1-L26](https://github.com/ArWikiCats/ArWikiCats/blob/4095f04e/ArWikiCats/translations_formats/DataModel/__init__.py#L1-L26)

 [ArWikiCats/translations_formats/__init__.py L12-L25](https://github.com/ArWikiCats/ArWikiCats/blob/4095f04e/ArWikiCats/translations_formats/__init__.py#L12-L25)
...
Sources: [ArWikiCats/translations_formats/DataModel/model_data_base.py L47](https://github.com/ArWikiCats/ArWikiCats/blob/4095f04e/ArWikiCats/translations_formats/DataModel/model_data_base.py#L47-L47)
...
Sources: [ArWikiCats/translations_formats/DataModel/model_data_base.py L52-L54](https://github.com/ArWikiCats/ArWikiCats/blob/4095f04e/ArWikiCats/translations_formats/DataModel/model_data_base.py#L52-L54)

 [ArWikiCats/translations_formats/DataModel/model_data_v2.py L42-L47](https://github.com/ArWikiCats/ArWikiCats/blob/4095f04e/ArWikiCats/translations_formats/DataModel/model_data_v2.py#L42-L47)
...
NORMALIZE["Normalize<br>Remove extra spaces"]
MATCH_KEY["Match Key<br>Regex search:<br>(?"]
REPLACE["Replace with Placeholder<br>british {sport} players"]
LOOKUP_TEMPLATE["Lookup Template<br>{nat} {sport} players"]
GET_VALUES["Get Arabic Values<br>football → كرة القدم<br>british → بريطانيون"]
SUBSTITUTE["Substitute Placeholders<br>لاعبو {sport_ar} {nat_ar}"]
OUTPUT["Final Label<br>لاعبو كرة القدم بريطانيون"]

INPUT --> NORMALIZE
NORMALIZE --> MATCH_KEY
MATCH_KEY --> REPLACE
REPLACE --> LOOKUP_TEMPLATE
LOOKUP_TEMPLATE --> GET_VALUES
GET_VALUES --> SUBSTITUTE
SUBSTITUTE --> OUTPUT
```
...
Sources: [ArWikiCats/translations_formats/DataModel/model_data_base.py L106-L131](https://github.com/ArWikiCats/ArWikiCats/blob/4095f04e/ArWikiCats/translations_formats/DataModel/model_data_base.py#L106-L131)

 [ArWikiCats/translations_formats/DataModel/model_data_base.py L242-L271](https://github.com/ArWikiCats/ArWikiCats/blob/4095f04e/ArWikiCats/translations_formats/DataModel/model_data_base.py#L242-L271)
...
Sources: [ArWikiCats/translations_formats/DataModel/model_data_base.py L38-L316](https://github.com/ArWikiCats/ArWikiCats/blob/4095f04e/ArWikiCats/translations_formats/DataModel/model_data_base.py#L38-L316)
...
Sources: [ArWikiCats/translations_formats/DataModel/model_data.py L35-L102](https://github.com/ArWikiCats/ArWikiCats/blob/4095f04e/ArWikiCats/translations_formats/DataModel/model_data.py#L35-L102)
...
Sources: [ArWikiCats/translations_formats/DataModel/model_data_v2.py L35-L125](https://github.com/ArWikiCats/ArWikiCats/blob/4095f04e/ArWikiCats/translations_formats/DataModel/model_data_v2.py#L35-L125)
...
Sources: [ArWikiCats/translations_formats/DataModel/model_multi_data_year_from.py L46-L162](https://github.com/ArWikiCats/ArWikiCats/blob/4095f04e/ArWikiCats/translations_formats/DataModel/model_multi_data_year_from.py#L46-L162)

 [ArWikiCats/translations_formats/DataModel/model_data_time.py L121-L154](https://github.com/ArWikiCats/ArWikiCats/blob/4095f04e/ArWikiCats/translations_formats/DataModel/model_data_time.py#L121-L154)
...
Sources: [ArWikiCats/translations_formats/__init__.py L65-L69](https://github.com/ArWikiCats/ArWikiCats/blob/4095f04e/ArWikiCats/translations_formats/__init__.py#L65-L69)

 [ArWikiCats/translations_formats/data_new_model.py L90-L95](https://github.com/ArWikiCats/ArWikiCats/blob/4095f04e/ArWikiCats/translations_formats/data_new_model.py#L90-L95)
...
NAT_NORM["Normalize Nationality<br>normalize_nat_label"]
TEMP1["{nat} football players"]
OTHER_NORM["Normalize Other<br>normalize_other_label"]
TEMP2["{nat} {sport} players"]
RESULT["NormalizeResult<br>nat_key: british<br>other_key: football<br>template_key: {nat} {sport} players"]
...
Sources: [ArWikiCats/translations_formats/DataModel/model_multi_data_base.py L70-L264](https://github.com/ArWikiCats/ArWikiCats/blob/4095f04e/ArWikiCats/translations_formats/DataModel/model_multi_data_base.py#L70-L264)
...
Sources: [ArWikiCats/translations_formats/DataModel/model_multi_data_year_from.py L164-L207](https://github.com/ArWikiCats/ArWikiCats/blob/4095f04e/ArWikiCats/translations_formats/DataModel/model_multi_data_year_from.py#L164-L207)
...
RESOLVER["Sports Resolver<br>resolve_sports_main"]
CREATE["Create Formatter<br>format_multi_data"]
FORMATTED["Load Templates<br>formatted_data = {...}"]
NATS["Load Nationalities<br>data_list = All_Nat"]
SPORTS["Load Sports<br>data_list2 = SPORT_KEY_RECORDS"]
BOT["MultiDataFormatterBase<br>country_bot + sport_bot"]
SEARCH["bot.search(category)"]
MATCH_NAT["Match nationality key<br>british"]
MATCH_SPORT["Match sport key<br>football"]
LOOKUP["Lookup template<br>{nat} {sport} players"]
REPLACE["Replace placeholders"]
RESULT["Return Arabic label"]
...
**Code location:** Resolvers typically construct formatters at module level or within resolver functions. For example, nationality resolvers use formatters defined in [ArWikiCats/new_resolvers/nationalities_resolvers/](https://github.com/ArWikiCats/ArWikiCats/blob/4095f04e/ArWikiCats/new_resolvers/nationalities_resolvers/)

 and sports resolvers in [ArWikiCats/new_resolvers/sports_resolvers/](https://github.com/ArWikiCats/ArWikiCats/blob/4095f04e/ArWikiCats/new_resolvers/sports_resolvers/)

Sources: Based on architectural patterns shown in [README.md L266-L344](https://github.com/ArWikiCats/ArWikiCats/blob/4095f04e/README.md#L266-L344)

 and resolver structure from diagrams
...
* `FormatDataBase.search()` at [ArWikiCats/translations_formats/DataModel/model_data_base.py L281-L295](https://github.com/ArWikiCats/ArWikiCats/blob/4095f04e/ArWikiCats/translations_formats/DataModel/model_data_base.py#L281-L295)
* `MultiDataFormatterBaseHelpers.create_label()` at [ArWikiCats/translations_formats/DataModel/model_multi_data_base.py L184](https://github.com/ArWikiCats/ArWikiCats/blob/4095f04e/ArWikiCats/translations_formats/DataModel/model_multi_data_base.py#L184-L184)

Sources: [ArWikiCats/translations_formats/DataModel/model_data_base.py L281-L295](https://github.com/ArWikiCats/ArWikiCats/blob/4095f04e/ArWikiCats/translations_formats/DataModel/model_data_base.py#L281-L295)

 [ArWikiCats/translations_formats/DataModel/model_multi_data_base.py L184-L227](https://github.com/ArWikiCats/ArWikiCats/blob/4095f04e/ArWikiCats/translations_formats/DataModel/model_multi_data_base.py#L184-L227)
...
Sources: Based on examples from architecture diagram and [ArWikiCats/translations_formats/DataModel/model_data.py L103-L152](https://github.com/ArWikiCats/ArWikiCats/blob/4095f04e/ArWikiCats/translations_formats/DataModel/model_data.py#L103-L152)
...
Sources: [ArWikiCats/translations_formats/DataModel/model_data_base.py L151-L177](https://github.com/ArWikiCats/ArWikiCats/blob/4095f04e/ArWikiCats/translations_formats/DataModel/model_data_base.py#L151-L177)
...
Sources: [ArWikiCats/translations_formats/DataModel/model_data_base.py L89](https://github.com/ArWikiCats/ArWikiCats/blob/4095f04e/ArWikiCats/translations_formats/DataModel/model_data_base.py#L89-L89)

 [ArWikiCats/translations_formats/DataModel/model_data_base.py L129](https://github.com/ArWikiCats/ArWikiCats/blob/4095f04e/ArWikiCats/translations_formats/DataModel/model_data_base.py#L129-L129)
...
Sources: [ArWikiCats/translations_formats/DataModel/model_multi_data_base.py L192-L211](https://github.com/ArWikiCats/ArWikiCats/blob/4095f04e/ArWikiCats/translations_formats/DataModel/model_multi_data_base.py#L192-L211)
...
Sources: [ArWikiCats/translations_formats/DataModel/model_multi_data_base.py L192-L194](https://github.com/ArWikiCats/ArWikiCats/blob/4095f04e/ArWikiCats/translations_formats/DataModel/model_multi_data_base.py#L192-L194)
...
Sources: Examples based on documentation in [ArWikiCats/translations_formats/DataModel/model_data.py L103-L152](https://github.com/ArWikiCats/ArWikiCats/blob/4095f04e/ArWikiCats/translations_formats/DataModel/model_data.py#L103-L152)

 and [ArWikiCats/translations_formats/multi_data.py L20-L34](https://github.com/ArWikiCats/ArWikiCats/blob/4095f04e/ArWikiCats/translations_formats/multi_data.py#L20-L34)

---

## Exports and Public API

The formatting system exports the following classes and functions through [ArWikiCats/translations_formats/__init__.py](https://github.com/ArWikiCats/ArWikiCats/blob/4095f04e/ArWikiCats/translations_formats/__init__.py)
...
Sources: [ArWikiCats/translations_formats/__init__.py L1-L93](https://github.com/ArWikiCats/ArWikiCats/blob/4095f04e/ArWikiCats/translations_formats/__init__.py#L1-L93)