...
For information about how formatters are used within resolvers, see [Resolver Chain](/ArWikiCats/ArWikiCats/5-resolver-system). For details on translation data organization, see [Translation Data](6.Translation-Data.md).
