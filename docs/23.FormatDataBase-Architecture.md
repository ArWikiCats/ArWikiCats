...
For information about concrete single-element formatter implementations (FormatData, FormatDataV2, FormatDataFrom), see [Single-Element Formatters](24.Single-Element-Formatters.md). For multi-element formatters that combine multiple FormatDataBase instances, see [Multi-Element Formatters](25.Multi-Element-Formatters.md). For details on placeholder syntax and template patterns, see [Template and Placeholder System](26.Template-and-Placeholder-System.md).
...
`FormatDataBase` is an abstract base class located at [ArWikiCats/translations_formats/DataModel/model_data_base.py L38-L410](../ArWikiCats/translations_formats/DataModel/model_data_base.py#L38-L410)
...
**Sources:** [ArWikiCats/translations_formats/DataModel/model_data_base.py L46-L56](../ArWikiCats/translations_formats/DataModel/model_data_base.py#L46-L56)

 [ArWikiCats/translations_formats/DataModel/model_data_base.py L75-L100](../ArWikiCats/translations_formats/DataModel/model_data_base.py#L75-L100)
...
**Sources:** [ArWikiCats/translations_formats/DataModel/model_data_base.py L264-L293](../ArWikiCats/translations_formats/DataModel/model_data_base.py#L264-L293)
 ...
 [ArWikiCats/translations_formats/DataModel/model_data_base.py L315-L337](../ArWikiCats/translations_formats/DataModel/model_data_base.py#L315-L337)
...
**Sources:** [ArWikiCats/translations_formats/DataModel/model_data_base.py L295-L313](../ArWikiCats/translations_formats/DataModel/model_data_base.py#L295-L313)
 ...
 [ArWikiCats/translations_formats/DataModel/model_data.py L100-L116](../ArWikiCats/translations_formats/DataModel/model_data.py#L100-L116)

 [ArWikiCats/translations_formats/DataModel/model_data_v2.py L81-L121](../ArWikiCats/translations_formats/DataModel/model_data_v2.py#L81-L121)
...
**Sources:** [ArWikiCats/translations_formats/DataModel/model_data_base.py L75-L100](../ArWikiCats/translations_formats/DataModel/model_data_base.py#L75-L100)

 [ArWikiCats/translations_formats/DataModel/model_data_base.py L264-L293](../ArWikiCats/translations_formats/DataModel/model_data_base.py#L264-L293)
...
**Sources:** [ArWikiCats/translations_formats/multi_data.py L96-L197](../ArWikiCats/translations_formats/multi_data.py#L96-L197)
 ...
 [ArWikiCats/translations_formats/data_with_time.py L109-L172](../ArWikiCats/translations_formats/data_with_time.py#L109-L172)
...
* No matching key is found [ArWikiCats/translations_formats/DataModel/model_data_base.py L275](../ArWikiCats/translations_formats/DataModel/model_data_base.py#L275-L275)
* No label exists for the matched key [ArWikiCats/translations_formats/DataModel/model_data_base.py L280](../ArWikiCats/translations_formats/DataModel/model_data_base.py#L280-L280)
* No template matches the normalized category [ArWikiCats/translations_formats/DataModel/model_data_base.py L285](../ArWikiCats/translations_formats/DataModel/model_data_base.py#L285-L285)

This allows callers to use simple truthiness checks: `if result: ...`

**Sources:** [ArWikiCats/translations_formats/DataModel/model_data_base.py L264-L293](../ArWikiCats/translations_formats/DataModel/model_data_base.py#L264-L293)

 [ArWikiCats/translations_formats/DataModel/model_data_base.py L371-L409](../ArWikiCats/translations_formats/DataModel/model_data_base.py#L371-L409)
...
| --- | --- | --- |
| `formatted_data_ci` | Case-insensitive template lookup | Constructor [ArWikiCats/translations_formats/DataModel/model_data_base.py L93](../ArWikiCats/translations_formats/DataModel/model_data_base.py#L93-L93) |
| `data_list_ci` | Case-insensitive key lookup | Constructor [ArWikiCats/translations_formats/DataModel/model_data_base.py L94](../ArWikiCats/translations_formats/DataModel/model_data_base.py#L94-L94) |
...
**Sources:** [ArWikiCats/translations_formats/DataModel/model_data_base.py L75-L133](../ArWikiCats/translations_formats/DataModel/model_data_base.py#L75-L133)
...
**Sources:** [ArWikiCats/translations_formats/DataModel/__init__.py L1-L21](../ArWikiCats/translations_formats/DataModel/__init__.py#L1-L21)
