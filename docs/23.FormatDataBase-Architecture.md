...
For information about concrete single-element formatter implementations (FormatData, FormatDataV2, FormatDataFrom), see [Single-Element Formatters](/ArWikiCats/ArWikiCats/6.2-single-element-formatters). For multi-element formatters that combine multiple FormatDataBase instances, see [Multi-Element Formatters](/ArWikiCats/ArWikiCats/6.3-multi-element-formatters). For details on placeholder syntax and template patterns, see [Template and Placeholder System](/ArWikiCats/ArWikiCats/6.4-template-and-placeholder-system).
