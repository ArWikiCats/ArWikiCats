...
Single-element formatters are classes that handle category translations containing one dynamic element to be replaced. They match a single key in the input category (e.g., "football", "yemen", "14th-century") and use template patterns to produce Arabic output. Single-element formatters form the building blocks for more complex multi-element formatters (see [Multi-Element Formatters](/ArWikiCats/ArWikiCats/6.3-multi-element-formatters)).

This page covers the three concrete implementations of single-element formatters: `FormatData`, `FormatDataV2`, and `FormatDataFrom`. For information about the abstract base class they inherit from, see [FormatDataBase Architecture](/ArWikiCats/ArWikiCats/6.1-formatdatabase-architecture). For information about factory functions that create these formatters, see [Factory Functions and Usage](/ArWikiCats/ArWikiCats/6.5-factory-functions-and-usage).
...
**Sources:** [ArWikiCats/translations_formats/DataModel/model_data_base.py L38-L74](https://github.com/ArWikiCats/ArWikiCats/blob/4095f04e/ArWikiCats/translations_formats/DataModel/model_data_base.py#L38-L74)

 [ArWikiCats/translations_formats/DataModel/model_data.py L37-L64](https://github.com/ArWikiCats/ArWikiCats/blob/4095f04e/ArWikiCats/translations_formats/DataModel/model_data.py#L37-L64)

 [ArWikiCats/translations_formats/DataModel/model_data_v2.py L32-L57](https://github.com/ArWikiCats/ArWikiCats/blob/4095f04e/ArWikiCats/translations_formats/DataModel/model_data_v2.py#L32-L57)
...
Input --> CheckDirect
CheckDirect --> Output
CheckDirect --> MatchKey
MatchKey --> CheckKey
CheckKey --> Fail
CheckKey --> GetLabel
GetLabel --> CheckLabel
CheckLabel --> Fail
CheckLabel --> GetTemplate
GetTemplate --> CheckTemplate
CheckTemplate --> Fail
CheckTemplate --> ApplyPattern
ApplyPattern --> Output
```
...
subgraph subGraph3 ["Template Selection"]
    Normalize
    Template
    Normalize --> Template
end

subgraph subGraph2 ["Data Lookup"]
    DataList
end

subgraph subGraph1 ["Key Matching"]
    Pattern
    Key
    Pattern --> Key
end
...
**Sources:** [ArWikiCats/translations_formats/DataModel/model_data.py L37-L132](https://github.com/ArWikiCats/ArWikiCats/blob/4095f04e/ArWikiCats/translations_formats/DataModel/model_data.py#L37-L132)
...
**Sources:** [ArWikiCats/translations_formats/DataModel/model_data.py L66-L132](https://github.com/ArWikiCats/ArWikiCats/blob/4095f04e/ArWikiCats/translations_formats/DataModel/model_data.py#L66-L132)
...
subgraph Multi-Replacement ["Multi-Replacement"]
    Replace1
    Replace2
    Result
    Replace1 --> Replace2
...
**Sources:** [ArWikiCats/translations_formats/DataModel/model_data_v2.py L32-L122](https://github.com/ArWikiCats/ArWikiCats/blob/4095f04e/ArWikiCats/translations_formats/DataModel/model_data_v2.py#L32-L122)
...
**Sources:** [ArWikiCats/translations_formats/DataModel/model_data_v2.py L59-L122](https://github.com/ArWikiCats/ArWikiCats/blob/4095f04e/ArWikiCats/translations_formats/DataModel/model_data_v2.py#L59-L122)
...
**Sources:** [ArWikiCats/translations_formats/DataModel/model_data_time.py L1-L67](https://github.com/ArWikiCats/ArWikiCats/blob/4095f04e/ArWikiCats/translations_formats/DataModel/model_data_time.py#L1-L67)
...
subgraph subGraph3 ["Template Application"]
    Template
    Replace
    Result
    Template --> Replace
...
subgraph subGraph2 ["Callback: search_callback"]
    Convert
end

subgraph subGraph1 ["Callback: match_key_callback"]
    Fix
    Match
    Fix --> Match
end
...
| **File Path** | [model_data.py](https://github.com/ArWikiCats/ArWikiCats/blob/4095f04e/model_data.py) | [model_data_v2.py](https://github.com/ArWikiCats/ArWikiCats/blob/4095f04e/model_data_v2.py) | [model_data_form.py](https://github.com/ArWikiCats/ArWikiCats/blob/4095f04e/model_data_form.py) <br>  (via [model_data_time.py](https://github.com/ArWikiCats/ArWikiCats/blob/4095f04e/model_data_time.py) <br> ) |

**Sources:** [ArWikiCats/translations_formats/DataModel/model_data.py L37-L132](https://github.com/ArWikiCats/ArWikiCats/blob/4095f04e/ArWikiCats/translations_formats/DataModel/model_data.py#L37-L132)

 [ArWikiCats/translations_formats/DataModel/model_data_v2.py L32-L122](https://github.com/ArWikiCats/ArWikiCats/blob/4095f04e/ArWikiCats/translations_formats/DataModel/model_data_v2.py#L32-L122)

 [ArWikiCats/translations_formats/DataModel/model_data_time.py L34-L66](https://github.com/ArWikiCats/ArWikiCats/blob/4095f04e/ArWikiCats/translations_formats/DataModel/model_data_time.py#L34-L66)
...
**Sources:** [ArWikiCats/translations_formats/__init__.py L1-L97](https://github.com/ArWikiCats/ArWikiCats/blob/4095f04e/ArWikiCats/translations_formats/__init__.py#L1-L97)

 [ArWikiCats/translations_formats/multi_data.py L1-L290](https://github.com/ArWikiCats/ArWikiCats/blob/4095f04e/ArWikiCats/translations_formats/multi_data.py#L1-L290)
...
Single-element formatters are used throughout the resolver chain (see [Resolver System](/ArWikiCats/ArWikiCats/5-resolver-system)). Each resolver typically instantiates one or more formatters:
...
subgraph subGraph3 ["Category Input"]
    Input1
    Input2
    Input3
end

subgraph subGraph2 ["Time Resolver"]
    TimeFormat
end

subgraph subGraph1 ["Nationality Resolver"]
    NatData
    NatFormat
    NatData --> NatFormat
end

subgraph subGraph0 ["Sports Resolver"]
    SportsData
    SportsFormat
...
**Sources:** [ArWikiCats/translations_formats/DataModel/model_data.py L1-L184](https://github.com/ArWikiCats/ArWikiCats/blob/4095f04e/ArWikiCats/translations_formats/DataModel/model_data.py#L1-L184)

 [ArWikiCats/translations_formats/DataModel/model_data_v2.py L1-L122](https://github.com/ArWikiCats/ArWikiCats/blob/4095f04e/ArWikiCats/translations_formats/DataModel/model_data_v2.py#L1-L122)

 [ArWikiCats/translations_formats/DataModel/model_data_time.py L1-L67](https://github.com/ArWikiCats/ArWikiCats/blob/4095f04e/ArWikiCats/translations_formats/DataModel/model_data_time.py#L1-L67)