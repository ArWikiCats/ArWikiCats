...
This page documents the classes that orchestrate two single-element formatters (see [Single-Element Formatters](/ArWikiCats/ArWikiCats/6.2-single-element-formatters)) to handle these complex translations. For information about the base formatting infrastructure, see [Format Data Models](/ArWikiCats/ArWikiCats/6.1-formatdatabase-architecture). For placeholder syntax and substitution logic, see [Template and Placeholder System](/ArWikiCats/ArWikiCats/6.4-template-and-placeholder-system).
