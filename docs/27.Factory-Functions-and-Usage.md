...
For information about the underlying formatter class architecture, see [FormatDataBase Architecture](23.FormatDataBase-Architecture.md). For details on the individual formatter classes themselves, see [Single-Element Formatters](/ArWikiCats/ArWikiCats/6.2-single-element-formatters) and [Multi-Element Formatters](/ArWikiCats/ArWikiCats/6.3-multi-element-formatters). For template and placeholder syntax, see [Template and Placeholder System](26.Template-and-Placeholder-System.md).
