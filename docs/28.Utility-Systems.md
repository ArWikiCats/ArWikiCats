...
For information about the overall resolution pipeline and how processing components fit into the translation flow, see [Resolution Pipeline](/ArWikiCats/ArWikiCats/3.1-resolution-pipeline). For details on template-based translation and placeholder substitution, see [Formatting System](/ArWikiCats/ArWikiCats/6-formatting-system).
...
**Sources**: [tests/ma_bots2/ar_lab/test_ar_lab_big_data.py L1-L483](https://github.com/ArWikiCats/ArWikiCats/blob/4095f04e/tests/ma_bots2/ar_lab/test_ar_lab_big_data.py#L1-L483)

 [tests/ma_bots2/ar_lab/test_bot_type_lab.py L1-L223](https://github.com/ArWikiCats/ArWikiCats/blob/4095f04e/tests/ma_bots2/ar_lab/test_bot_type_lab.py#L1-L223)

 [tasks/ar_lab_task.md L1-L154](https://github.com/ArWikiCats/ArWikiCats/blob/4095f04e/tasks/ar_lab_task.md#L1-L154)
...
**Sources**: [tests/ma_bots2/ar_lab/test_bot_type_country.py L1-L19](https://github.com/ArWikiCats/ArWikiCats/blob/4095f04e/tests/ma_bots2/ar_lab/test_bot_type_country.py#L1-L19)
...
**Sources**: [tests/ma_bots2/ar_lab/test_bot_type_lab.py L9-L223](https://github.com/ArWikiCats/ArWikiCats/blob/4095f04e/tests/ma_bots2/ar_lab/test_bot_type_lab.py#L9-L223)
...
**Sources**: [tests/ma_bots2/ar_lab/test_bot_con_lab.py L1-L218](https://github.com/ArWikiCats/ArWikiCats/blob/4095f04e/tests/ma_bots2/ar_lab/test_bot_con_lab.py#L1-L218)
...
**Sources**: [tests/ma_bots2/country2_bots/test_split_text_extended.py L1-L407](https://github.com/ArWikiCats/ArWikiCats/blob/4095f04e/tests/ma_bots2/country2_bots/test_split_text_extended.py#L1-L407)
...
**Sources**: [tests/ma_bots2/ar_lab/test_separator_fixing.py L21-L74](https://github.com/ArWikiCats/ArWikiCats/blob/4095f04e/tests/ma_bots2/ar_lab/test_separator_fixing.py#L21-L74)
...
**Sources**: [tests/ma_bots2/ar_lab/test_separator_fixing.py L76-L164](https://github.com/ArWikiCats/ArWikiCats/blob/4095f04e/tests/ma_bots2/ar_lab/test_separator_fixing.py#L76-L164)

 [tests/ma_bots2/ar_lab/test_separator_fixing_integration.py L61-L101](https://github.com/ArWikiCats/ArWikiCats/blob/4095f04e/tests/ma_bots2/ar_lab/test_separator_fixing_integration.py#L61-L101)
...
3. **Resolve**: Pass through resolver chain (see [Resolver Chain](/ArWikiCats/ArWikiCats/5-resolver-system))
...
**Sources**: [tests/ma_bots2/ar_lab/test_ar_lab_big_data.py L1-L483](https://github.com/ArWikiCats/ArWikiCats/blob/4095f04e/tests/ma_bots2/ar_lab/test_ar_lab_big_data.py#L1-L483)
 ...
 [tests/ma_bots2/ar_lab/test_separator_fixing_integration.py L104-L137](https://github.com/ArWikiCats/ArWikiCats/blob/4095f04e/tests/ma_bots2/ar_lab/test_separator_fixing_integration.py#L104-L137)
...
**Sources**: [tasks/ar_lab_task.md L1-L154](https://github.com/ArWikiCats/ArWikiCats/blob/4095f04e/tasks/ar_lab_task.md#L1-L154)
...
**Sources**: All test files in [tests/ma_bots2/](https://github.com/ArWikiCats/ArWikiCats/blob/4095f04e/tests/ma_bots2/)
...
**Sources**: [tests/ma_bots2/ar_lab/test_ar_lab_big_data.py L10-L19](https://github.com/ArWikiCats/ArWikiCats/blob/4095f04e/tests/ma_bots2/ar_lab/test_ar_lab_big_data.py#L10-L19)

 [tests/ma_bots2/country2_bots/test_split_text_extended.py L11-L17](https://github.com/ArWikiCats/ArWikiCats/blob/4095f04e/tests/ma_bots2/country2_bots/test_split_text_extended.py#L11-L17)