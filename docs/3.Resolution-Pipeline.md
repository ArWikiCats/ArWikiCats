...
**Caching:** The `resolve_label` function uses `@functools.lru_cache(maxsize=None)` [ArWikiCats/main_processers/main_resolve.py L52](../ArWikiCats/main_processers/main_resolve.py#L52)
...
The `change_cat` function [ArWikiCats/format_bots/__init__.py](../ArWikiCats/format_bots/__init__.py)
 ...
 (imported in [ArWikiCats/main_processers/main_resolve.py L21](../ArWikiCats/main_processers/main_resolve.py#L21)
...
The `filter_en.filter_cat` function [ArWikiCats/main_processers/main_resolve.py L71](../ArWikiCats/main_processers/main_resolve.py#L71)
...
**Sources:** [ArWikiCats/main_processers/main_resolve.py L84](../ArWikiCats/main_processers/main_resolve.py#L84)
...
The `fixlabel` function [ArWikiCats/fix/fixtitle.py](../ArWikiCats/fix/fixtitle.py)
 ...
 (called at [ArWikiCats/main_processers/main_resolve.py L128](../ArWikiCats/main_processers/main_resolve.py#L128)
...
The resolved label is prefixed with `"تصنيف:"` by the EventProcessor's `_prefix_label` method [ArWikiCats/main_processers/event_lab_bot.py L301](../ArWikiCats/main_processers/event_lab_bot.py#L301)
...
**Sources:** [ArWikiCats/main_processers/main_resolve.py L128](../ArWikiCats/main_processers/main_resolve.py#L128)
...
**Sources:** [ArWikiCats/main_processers/main_resolve.py L37-L52](../ArWikiCats/main_processers/main_resolve.py#L37-L52)
 ...
 [ArWikiCats/main_processers/event_lab_bot.py L32](../ArWikiCats/main_processers/event_lab_bot.py#L32)
...
The `start_tgc_resolver_first` setting [ArWikiCats/main_processers/main_resolve.py L108](../ArWikiCats/main_processers/main_resolve.py#L108)
