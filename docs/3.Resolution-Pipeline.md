...
For information about specific resolver implementations (Year Pattern, Nationality, Country Name, etc.), see the Resolver Chain pages [5.1](15.Time-Pattern-Resolvers.md)-[5.7](21.Legacy-Resolvers.md). For details about the formatting system that resolvers use, see [6](22.Formatting-System.md). For category parsing internals, see [3.3](5.Resolver-Chain-Priority-System.md).
...
This is the main modular resolver that chains together specialized resolvers in the `new_resolvers/` directory. See [5](14.Resolver-System.md) for detailed documentation of each resolver.
