...
> * [help_scripts/split_non_geography.py](https://github.com/ArWikiCats/ArWikiCats/blob/4095f04e/help_scripts/split_non_geography.py)
...
For information about how translation data is organized, see [Data Architecture](/ArWikiCats/ArWikiCats/3.2-data-architecture). For the data aggregation pipeline, see [Data Aggregation Pipeline](/ArWikiCats/ArWikiCats/4.1-data-aggregation-pipeline).
...
| --- | --- | --- | --- | --- |
| `split_non_geography.py` | [help_scripts/](https://github.com/ArWikiCats/ArWikiCats/blob/4095f04e/help_scripts/) | Classify geographic vs non-geographic labels | JSON translation files | Geographic + Non-geographic JSON files |
...
**Sources:** [help_scripts/split_non_geography.py L1-L424](https://github.com/ArWikiCats/ArWikiCats/blob/4095f04e/help_scripts/split_non_geography.py#L1-L424)
...
**Sources:** [help_scripts/split_non_geography.py L1-L13](https://github.com/ArWikiCats/ArWikiCats/blob/4095f04e/help_scripts/split_non_geography.py#L1-L13)
...
The `classify_entries()` function at [help_scripts/split_non_geography.py L343-L376](https://github.com/ArWikiCats/ArWikiCats/blob/4095f04e/help_scripts/split_non_geography.py#L343-L376)
...
**Sources:** [help_scripts/split_non_geography.py L343-L376](https://github.com/ArWikiCats/ArWikiCats/blob/4095f04e/help_scripts/split_non_geography.py#L343-L376)

 [help_scripts/split_non_geography.py L280-L336](https://github.com/ArWikiCats/ArWikiCats/blob/4095f04e/help_scripts/split_non_geography.py#L280-L336)

### Keyword Categories

The script maintains a comprehensive taxonomy of non-geographic keywords organized by domain. The `NON_GEO_KEYWORDS_EN` dictionary at [help_scripts/split_non_geography.py L33-L231](https://github.com/ArWikiCats/ArWikiCats/blob/4095f04e/help_scripts/split_non_geography.py#L33-L231)
...
The `CHECK_AR_ALSO` dictionary at [help_scripts/split_non_geography.py L28-L31](https://github.com/ArWikiCats/ArWikiCats/blob/4095f04e/help_scripts/split_non_geography.py#L28-L31)
...
**Sources:** [help_scripts/split_non_geography.py L28-L231](https://github.com/ArWikiCats/ArWikiCats/blob/4095f04e/help_scripts/split_non_geography.py#L28-L231)
...
Located at [help_scripts/split_non_geography.py L281-L306](https://github.com/ArWikiCats/ArWikiCats/blob/4095f04e/help_scripts/split_non_geography.py#L281-L306)
...
Located at [help_scripts/split_non_geography.py L309-L314](https://github.com/ArWikiCats/ArWikiCats/blob/4095f04e/help_scripts/split_non_geography.py#L309-L314)

 this function checks for Arabic keywords in the translated value.

**Keywords Checked:** 12 common Arabic non-geographic terms from `NON_GEO_KEYWORDS_AR` at [help_scripts/split_non_geography.py L237-L252](https://github.com/ArWikiCats/ArWikiCats/blob/4095f04e/help_scripts/split_non_geography.py#L237-L252)
...
Located at [help_scripts/split_non_geography.py L317-L320](https://github.com/ArWikiCats/ArWikiCats/blob/4095f04e/help_scripts/split_non_geography.py#L317-L320)

 this function identifies biological taxonomy names using scientific suffixes.

**Biological Suffixes** from [help_scripts/split_non_geography.py L258-L273](https://github.com/ArWikiCats/ArWikiCats/blob/4095f04e/help_scripts/split_non_geography.py#L258-L273)
...
Located at [help_scripts/split_non_geography.py L323-L335](https://github.com/ArWikiCats/ArWikiCats/blob/4095f04e/help_scripts/split_non_geography.py#L323-L335)
...
**Sources:** [help_scripts/split_non_geography.py L281-L335](https://github.com/ArWikiCats/ArWikiCats/blob/4095f04e/help_scripts/split_non_geography.py#L281-L335)

 [help_scripts/split_non_geography.py L237-L273](https://github.com/ArWikiCats/ArWikiCats/blob/4095f04e/help_scripts/split_non_geography.py#L237-L273)
...
The `filter_file()` function at [help_scripts/split_non_geography.py L379-L392](https://github.com/ArWikiCats/ArWikiCats/blob/4095f04e/help_scripts/split_non_geography.py#L379-L392)
...
**Sources:** [help_scripts/split_non_geography.py L379-L392](https://github.com/ArWikiCats/ArWikiCats/blob/4095f04e/help_scripts/split_non_geography.py#L379-L392)

### Main Execution

The `main()` function at [help_scripts/split_non_geography.py L395-L420](https://github.com/ArWikiCats/ArWikiCats/blob/4095f04e/help_scripts/split_non_geography.py#L395-L420)

 orchestrates the classification process:

**Target Files:**

The script is configured to process files from the `jsons_dir` directory at [help_scripts/split_non_geography.py L21-L22](https://github.com/ArWikiCats/ArWikiCats/blob/4095f04e/help_scripts/split_non_geography.py#L21-L22)
...
**Default Processing:**
Currently configured to process: [help_scripts/split_non_geography.py L401-L403](https://github.com/ArWikiCats/ArWikiCats/blob/4095f04e/help_scripts/split_non_geography.py#L401-L403)
...
The script includes commented-out examples for processing other files: [help_scripts/split_non_geography.py L397-L400](https://github.com/ArWikiCats/ArWikiCats/blob/4095f04e/help_scripts/split_non_geography.py#L397-L400)
...
**Sources:** [help_scripts/split_non_geography.py L395-L424](https://github.com/ArWikiCats/ArWikiCats/blob/4095f04e/help_scripts/split_non_geography.py#L395-L424)

 [help_scripts/split_non_geography.py L21-L22](https://github.com/ArWikiCats/ArWikiCats/blob/4095f04e/help_scripts/split_non_geography.py#L21-L22)
...
**Sources:** [help_scripts/split_non_geography.py L281-L335](https://github.com/ArWikiCats/ArWikiCats/blob/4095f04e/help_scripts/split_non_geography.py#L281-L335)
 ...
 [help_scripts/split_non_geography.py L343-L376](https://github.com/ArWikiCats/ArWikiCats/blob/4095f04e/help_scripts/split_non_geography.py#L343-L376)
...
To add a new non-geographic category, update `NON_GEO_KEYWORDS_EN` at [help_scripts/split_non_geography.py L33-L231](https://github.com/ArWikiCats/ArWikiCats/blob/4095f04e/help_scripts/split_non_geography.py#L33-L231)
...
Update `NON_GEO_KEYWORDS_AR` at [help_scripts/split_non_geography.py L237-L252](https://github.com/ArWikiCats/ArWikiCats/blob/4095f04e/help_scripts/split_non_geography.py#L237-L252)
...
For keywords that require Arabic confirmation (like "bridge"/"بريدج"), update `CHECK_AR_ALSO` at [help_scripts/split_non_geography.py L28-L31](https://github.com/ArWikiCats/ArWikiCats/blob/4095f04e/help_scripts/split_non_geography.py#L28-L31)
...
Modify the `files` list in `main()` at [help_scripts/split_non_geography.py L396-L403](https://github.com/ArWikiCats/ArWikiCats/blob/4095f04e/help_scripts/split_non_geography.py#L396-L403)
...
**Sources:** [help_scripts/split_non_geography.py L28-L231](https://github.com/ArWikiCats/ArWikiCats/blob/4095f04e/help_scripts/split_non_geography.py#L28-L231)
 ...
 [help_scripts/split_non_geography.py L237-L252](https://github.com/ArWikiCats/ArWikiCats/blob/4095f04e/help_scripts/split_non_geography.py#L237-L252)

 [help_scripts/split_non_geography.py L396-L403](https://github.com/ArWikiCats/ArWikiCats/blob/4095f04e/help_scripts/split_non_geography.py#L396-L403)
...
**Sources:** [help_scripts/split_non_geography.py L343-L376](https://github.com/ArWikiCats/ArWikiCats/blob/4095f04e/help_scripts/split_non_geography.py#L343-L376)
 ...
 [help_scripts/split_non_geography.py L392](https://github.com/ArWikiCats/ArWikiCats/blob/4095f04e/help_scripts/split_non_geography.py#L392-L392)
...
**Sources:** [help_scripts/split_non_geography.py L281-L335](https://github.com/ArWikiCats/ArWikiCats/blob/4095f04e/help_scripts/split_non_geography.py#L281-L335)
 ...
 [help_scripts/split_non_geography.py L28-L31](https://github.com/ArWikiCats/ArWikiCats/blob/4095f04e/help_scripts/split_non_geography.py#L28-L31)
...
* [ArWikiCats/translations/jsons/geography/P17_PP.json](https://github.com/ArWikiCats/ArWikiCats/blob/4095f04e/ArWikiCats/translations/jsons/geography/P17_PP.json)  - Country and region data
* [ArWikiCats/translations/jsons/geography/P17_2_final_ll.json](https://github.com/ArWikiCats/ArWikiCats/blob/4095f04e/ArWikiCats/translations/jsons/geography/P17_2_final_ll.json)  - Extended geographic data
* [ArWikiCats/translations/jsons/geography/popopo.json](https://github.com/ArWikiCats/ArWikiCats/blob/4095f04e/ArWikiCats/translations/jsons/geography/popopo.json)  - Additional place names
* [ArWikiCats/translations/jsons/cities/](https://github.com/ArWikiCats/ArWikiCats/blob/4095f04e/ArWikiCats/translations/jsons/cities/)  - City-specific translations

For more on data sources, see [Data Architecture](/ArWikiCats/ArWikiCats/3.2-data-architecture) and [Geographic Data](/ArWikiCats/ArWikiCats/4.2-geographic-data).
...
* [Country Name Resolvers](/ArWikiCats/ArWikiCats/5.3-country-name-resolvers) - Uses cleaned P17_PP.json for country translations
* [Geographic Data](/ArWikiCats/ArWikiCats/4.2-geographic-data) - Builds `COUNTRY_LABEL_OVERRIDES` and city indexes
...
* Complementary to data builders in [ArWikiCats/translations/](https://github.com/ArWikiCats/ArWikiCats/blob/4095f04e/ArWikiCats/translations/)  modules
* Used before data aggregation (see [Data Aggregation Pipeline](/ArWikiCats/ArWikiCats/4.1-data-aggregation-pipeline))
* Supports data quality validation

**Sources:** [help_scripts/split_non_geography.py L21-L22](https://github.com/ArWikiCats/ArWikiCats/blob/4095f04e/help_scripts/split_non_geography.py#L21-L22)
