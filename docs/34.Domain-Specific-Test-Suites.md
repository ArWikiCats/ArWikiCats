...
This page documents the domain-specific test suites that validate translation accuracy for each resolver in the ArWikiCats system. Tests are organized by translation domain (nationalities, ministers, films, countries, etc.) and use data-driven testing with pytest parametrization. For information about test data organization and JSON file structure, see [Test Data Organization](/ArWikiCats/ArWikiCats/8.1-test-organization). For test execution utilities and markers, see [Test Utilities and Markers](/ArWikiCats/ArWikiCats/8.3-test-utilities).
...
**Sources:** [tests/event_lists/test_2.py](https://github.com/ArWikiCats/ArWikiCats/blob/4095f04e/tests/event_lists/test_2.py)

 [tests/new_resolvers/nationalities_resolvers/nationalities_v2/test_nats_v2.py](https://github.com/ArWikiCats/ArWikiCats/blob/4095f04e/tests/new_resolvers/nationalities_resolvers/nationalities_v2/test_nats_v2.py)

 [tests/event_lists/test_ministers.py](https://github.com/ArWikiCats/ArWikiCats/blob/4095f04e/tests/event_lists/test_ministers.py)

 [examples/data/5k.json](https://github.com/ArWikiCats/ArWikiCats/blob/4095f04e/examples/data/5k.json)

 [examples/data/2025-11-28.json](https://github.com/ArWikiCats/ArWikiCats/blob/4095f04e/examples/data/2025-11-28.json)

 [examples/data/1k.json](https://github.com/ArWikiCats/ArWikiCats/blob/4095f04e/examples/data/1k.json)
...
**Sources:** [tests/new_resolvers/nationalities_resolvers/nationalities_v2/test_nats_v2.py L1-L300](https://github.com/ArWikiCats/ArWikiCats/blob/4095f04e/tests/new_resolvers/nationalities_resolvers/nationalities_v2/test_nats_v2.py#L1-L300)

 [tests/event_lists/test_2.py L1-L601](https://github.com/ArWikiCats/ArWikiCats/blob/4095f04e/tests/event_lists/test_2.py#L1-L601)

 [tests/new_resolvers/nationalities_resolvers/nationalities_v2/test_nats_v2_jobs.py](https://github.com/ArWikiCats/ArWikiCats/blob/4095f04e/tests/new_resolvers/nationalities_resolvers/nationalities_v2/test_nats_v2_jobs.py)
...
**Sources:** [tests/event_lists/test_ministers.py L1-L50](https://github.com/ArWikiCats/ArWikiCats/blob/4095f04e/tests/event_lists/test_ministers.py#L1-L50)

 [ArWikiCats/translations/politics/ministers.py L1-L104](https://github.com/ArWikiCats/ArWikiCats/blob/4095f04e/ArWikiCats/translations/politics/ministers.py#L1-L104)
...
**Sources:** [examples/data/5k.json L1-L50](https://github.com/ArWikiCats/ArWikiCats/blob/4095f04e/examples/data/5k.json#L1-L50)

 [examples/data/2025-11-28.json L1-L40](https://github.com/ArWikiCats/ArWikiCats/blob/4095f04e/examples/data/2025-11-28.json#L1-L40)
...
**Sources:** [examples/data/films_with_time.json](https://github.com/ArWikiCats/ArWikiCats/blob/4095f04e/examples/data/films_with_time.json)

 [examples/data/television series.json](https://github.com/ArWikiCats/ArWikiCats/blob/4095f04e/examples/data/television series.json)

 [examples/data/endings.json](https://github.com/ArWikiCats/ArWikiCats/blob/4095f04e/examples/data/endings.json)

 [examples/data/novels.json L1-L35](https://github.com/ArWikiCats/ArWikiCats/blob/4095f04e/examples/data/novels.json#L1-L35)
...
**Sources:** [tests/event_lists/papua_new_guinea/test_papua_new_guinea.py L1-L200](https://github.com/ArWikiCats/ArWikiCats/blob/4095f04e/tests/event_lists/papua_new_guinea/test_papua_new_guinea.py#L1-L200)
...
**Sources:** [examples/data/relations_data.json L1-L10](https://github.com/ArWikiCats/ArWikiCats/blob/4095f04e/examples/data/relations_data.json#L1-L10)
...
**Sources:** [examples/data/5k.json L1-L100](https://github.com/ArWikiCats/ArWikiCats/blob/4095f04e/examples/data/5k.json#L1-L100)

 [examples/data/2025-11-28.json L1-L50](https://github.com/ArWikiCats/ArWikiCats/blob/4095f04e/examples/data/2025-11-28.json#L1-L50)

 [examples/data/1k.json L1-L50](https://github.com/ArWikiCats/ArWikiCats/blob/4095f04e/examples/data/1k.json#L1-L50)

 [examples/data/teams_to_test.json](https://github.com/ArWikiCats/ArWikiCats/blob/4095f04e/examples/data/teams_to_test.json)
...
**Sources:** [tests/new_resolvers/nationalities_resolvers/nationalities_v2/test_nats_v2.py L1-L10](https://github.com/ArWikiCats/ArWikiCats/blob/4095f04e/tests/new_resolvers/nationalities_resolvers/nationalities_v2/test_nats_v2.py#L1-L10)

 [tests/event_lists/test_2.py L1-L10](https://github.com/ArWikiCats/ArWikiCats/blob/4095f04e/tests/event_lists/test_2.py#L1-L10)

 [tests/event_lists/test_ministers.py L1-L10](https://github.com/ArWikiCats/ArWikiCats/blob/4095f04e/tests/event_lists/test_ministers.py#L1-L10)
...
**Sources:** [tests/event_lists/test_2.py](https://github.com/ArWikiCats/ArWikiCats/blob/4095f04e/tests/event_lists/test_2.py)
 ...
 [ArWikiCats/translations/politics/ministers.py](https://github.com/ArWikiCats/ArWikiCats/blob/4095f04e/ArWikiCats/translations/politics/ministers.py)