...
> * [_work_files/non-fiction.json](https://github.com/ArWikiCats/ArWikiCats/blob/4095f04e/_work_files/non-fiction.json)
...
For information about how these datasets are used in the test system, see [Test Utilities](/ArWikiCats/ArWikiCats/8.3-test-utilities). For the overall testing architecture, see [Testing and Validation](/ArWikiCats/ArWikiCats/8-testing-and-validation).
...
Novels --> UnitTests
TVSeries --> IntegrationTests
Endings --> E2ETests
NonFiction --> IntegrationTests

subgraph subGraph1 ["Test Consumers"]
    UnitTests
    IntegrationTests
    E2ETests
end

subgraph subGraph0 ["Example Data Structure"]
    ExamplesRoot
    Novels
    TVSeries
    Endings
...
**Sources:** [examples/data/novels.json](https://github.com/ArWikiCats/ArWikiCats/blob/4095f04e/examples/data/novels.json)
...
**File Location:** [examples/data/novels.json](https://github.com/ArWikiCats/ArWikiCats/blob/4095f04e/examples/data/novels.json)
...
**Sources:** [examples/data/novels.json L1-L77](https://github.com/ArWikiCats/ArWikiCats/blob/4095f04e/examples/data/novels.json#L1-L77)
...
**File Location:** [examples/data/television series.json](https://github.com/ArWikiCats/ArWikiCats/blob/4095f04e/examples/data/television series.json)
...
**Sources:** [examples/data/television L1-L57](https://github.com/ArWikiCats/ArWikiCats/blob/4095f04e/examples/data/television series.json#L1-L57)
...
**File Location:** [examples/data/endings.json](https://github.com/ArWikiCats/ArWikiCats/blob/4095f04e/examples/data/endings.json)
...
**File Location:** [_work_files/non-fiction.json](https://github.com/ArWikiCats/ArWikiCats/blob/4095f04e/_work_files/non-fiction.json)
...
**Sources:** [_work_files/non-fiction.json L1-L488](https://github.com/ArWikiCats/ArWikiCats/blob/4095f04e/_work_files/non-fiction.json#L1-L488)
...
subgraph subGraph2 ["Value Components"]
    TasnifPrefix
    TranslatedContent
end
...
ResolverChain["Resolver Chain<br>Nationality, Time, Genre"]
Pipeline["Complete Pipeline<br>Input to Arabic output"]
...
UnitTests --> ResolverChain
IntegrationTests --> Pipeline

subgraph subGraph2 ["Test Types"]
    UnitTests
    IntegrationTests
    RegressionTests
    CoverageTests
...
subgraph subGraph0 ["Example Datasets"]
    Novels
    TVSeries
    Endings
    NonFiction
...
subgraph subGraph2 ["Format Templates"]
    T1
    T2
    T3
end

subgraph subGraph1 ["Resolver Mapping"]
    R1
    R2
    R3
    R4
...
subgraph subGraph0 ["novels.json Patterns"]
    N1
    N2
    N3
end
