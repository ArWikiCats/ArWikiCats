...
> * [.gitignore](https://github.com/ArWikiCats/ArWikiCats/blob/4095f04e/.gitignore)
...
* For adding new translation entries and maintaining data consistency, see [Adding Translation Data](/ArWikiCats/ArWikiCats/9.1-adding-translation-data)
* For implementing new category resolvers and integrating them into the resolver chain, see [Creating New Resolvers](/ArWikiCats/ArWikiCats/9.2-creating-new-resolvers)
* For using helper scripts and utilities, see [Utilities and Scripts](/ArWikiCats/ArWikiCats/9.3-code-style-and-standards)

For general usage and API documentation, see [Getting Started](/ArWikiCats/ArWikiCats/2-getting-started). For understanding the overall system architecture, see [Architecture](/ArWikiCats/ArWikiCats/3-architecture).
...
EXPORT["Export in init.py:<br>translations/init.py"]
...
**Sources:** [changelog.md L1-L80](https://github.com/ArWikiCats/ArWikiCats/blob/4095f04e/changelog.md#L1-L80)

 [README.md L449-L514](https://github.com/ArWikiCats/ArWikiCats/blob/4095f04e/README.md#L449-L514)

 [ArWikiCats/new_resolvers/reslove_all.py](https://github.com/ArWikiCats/ArWikiCats/blob/4095f04e/ArWikiCats/new_resolvers/reslove_all.py)

 [tests/](https://github.com/ArWikiCats/ArWikiCats/blob/4095f04e/tests/)
...
JOBS["jobs_resolvers/init.py:<br>main_jobs_resolvers()"]
SPORTS["sports_resolvers/init.py:<br>main_sports_resolvers()"]
NATS["nationalities_resolvers/init.py:<br>resolve_nat_genders_pattern_v2()"]
COUNTRIES["countries_names_resolvers/init.py:<br>resolve_by_countries_names_v2()"]
FILMS["resolve_films_bots/init.py:<br>te_films()"]
LEGACY_CLASS["legacy_bots/init.py:<br>LegacyBotsResolver class"]
LEGACY_FUNC["legacy_resolvers(category: str)"]
COUNTRY_BOT["resolvers/country_resolver.py:<br>Get_country2()"]
EVENT_BOT["event_lab_bot.py:<br>event_label_work()"]
YEAR_BOT["with_years_bot.py:<br>label_for_years()"]
...
subgraph Legacy ["Legacy Resolvers (legacy_bots/)"]
    ...
    EVENT_BOT
    YEAR_BOT
    LEGACY_CLASS --> COUNTRY_BOT
    LEGACY_CLASS --> EVENT_BOT
    LEGACY_CLASS --> YEAR_BOT
...
subgraph ResolverChain ["Resolver Chain (new_resolvers/reslove_all.py)"]
    ...
    FILMS
    ALL_RESOLVERS --> JOBS
    ALL_RESOLVERS --> SPORTS
    ALL_RESOLVERS --> NATS
    ALL_RESOLVERS --> COUNTRIES
    ALL_RESOLVERS --> FILMS
end
...
subgraph API ["Public API (ArWikiCats/init.py)"]
    API_FUNCS
end
```
...
1. **Chain of Responsibility**: `new_resolvers_all()` tries resolvers in priority order until match found [new_resolvers/reslove_all.py](https://github.com/ArWikiCats/ArWikiCats/blob/4095f04e/new_resolvers/reslove_all.py)
2. **Template Method**: `FormatDataBase` defines abstract interface, subclasses implement search logic [translations_formats/DataModel/model_data_base.py](https://github.com/ArWikiCats/ArWikiCats/blob/4095f04e/translations_formats/DataModel/model_data_base.py)
3. **Factory Pattern**: `format_multi_data()`, `format_year_country_data()` create configured formatter instances [translations_formats/multi_data.py](https://github.com/ArWikiCats/ArWikiCats/blob/4095f04e/translations_formats/multi_data.py)
4. **Singleton Cache**: `@lru_cache(maxsize=1)` on data loading functions ensures single load [translations/jobs/Jobs.py](https://github.com/ArWikiCats/ArWikiCats/blob/4095f04e/translations/jobs/Jobs.py)
5. **Strategy Pattern**: Different resolver strategies (jobs, sports, nationalities) implement common resolver interface

**Sources:** [ArWikiCats/__init__.py](https://github.com/ArWikiCats/ArWikiCats/blob/4095f04e/ArWikiCats/__init__.py)
 ...
 [ArWikiCats/translations_formats/DataModel/](https://github.com/ArWikiCats/ArWikiCats/blob/4095f04e/ArWikiCats/translations_formats/DataModel/)
...
| --- | --- | --- | --- |
| `SAVE_DATA_PATH` | Set data output path | `""` | [ArWikiCats/config.py L27-L43](https://github.com/ArWikiCats/ArWikiCats/blob/4095f04e/ArWikiCats/config.py#L27-L43) |
...
The system also uses command-line arguments for runtime behavior control via [ArWikiCats/config.py L11-L16](https://github.com/ArWikiCats/ArWikiCats/blob/4095f04e/ArWikiCats/config.py#L11-L16)
...
**Sources:** [ArWikiCats/config.py L1-L52](https://github.com/ArWikiCats/ArWikiCats/blob/4095f04e/ArWikiCats/config.py#L1-L52)
...
LEGACY_UNIT["tests/unit/legacy_bots/<br>test_event_lab_bot.py (84% coverage)<br>test_mk3.py (83% coverage)<br>test_year_or_typeo.py (66% coverage)"]
FORMATS_UNIT["tests/unit/translations_formats/<br>test_model_data.py<br>test_model_multi_data.py<br>test_time_patterns_formats.py"]
RESOLVERS_UNIT["tests/unit/new_resolvers/<br>test_jobs_resolvers.py<br>test_sports_resolvers.py"]
EVENT_LISTS["tests/integration/event_lists/<br>test_south_african.py<br>test_defunct.py<br>test_papua_new_guinean.py"]
FORMATS_INT["tests/integration/translations_formats/<br>test_model_data_inte.py<br>test_model_data_v2_inte.py"]
FULL_PIPELINE["tests/e2e/<br>Full category translation<br>pipeline validation"]
...
UNIT --> FORMATS_UNIT
UNIT --> RESOLVERS_UNIT
INTEGRATION --> EVENT_LISTS
INTEGRATION --> FORMATS_INT
E2E --> FULL_PIPELINE
...
**Sources:** [tests/unit/](https://github.com/ArWikiCats/ArWikiCats/blob/4095f04e/tests/unit/)

 [tests/integration/](https://github.com/ArWikiCats/ArWikiCats/blob/4095f04e/tests/integration/)

 [tests/e2e/](https://github.com/ArWikiCats/ArWikiCats/blob/4095f04e/tests/e2e/)

 [tests/utils/dump_runner.py](https://github.com/ArWikiCats/ArWikiCats/blob/4095f04e/tests/utils/dump_runner.py)

 [changelog.md L1-L110](https://github.com/ArWikiCats/ArWikiCats/blob/4095f04e/changelog.md#L1-L110)

 [README.md L442-L469](https://github.com/ArWikiCats/ArWikiCats/blob/4095f04e/README.md#L442-L469)

### Test Writing Patterns

**Pattern 1: Parametrized Tests with Dictionary**

[tests/event_lists/test_defunct.py L1-L74](https://github.com/ArWikiCats/ArWikiCats/blob/4095f04e/tests/event_lists/test_defunct.py#L1-L74)
...
**Sources:** [tests/event_lists/test_defunct.py L1-L74](https://github.com/ArWikiCats/ArWikiCats/blob/4095f04e/tests/event_lists/test_defunct.py#L1-L74)

 [README.md L449-L483](https://github.com/ArWikiCats/ArWikiCats/blob/4095f04e/README.md#L449-L483)

 [changelog.md L205-L220](https://github.com/ArWikiCats/ArWikiCats/blob/4095f04e/changelog.md#L205-L220)
...
**Sources:** [README.md L499-L514](https://github.com/ArWikiCats/ArWikiCats/blob/4095f04e/README.md#L499-L514)

 [changelog.md L42-L47](https://github.com/ArWikiCats/ArWikiCats/blob/4095f04e/changelog.md#L42-L47)
...
**Implementation Example from [ArWikiCats/translations/jobs/Jobs.py](https://github.com/ArWikiCats/ArWikiCats/blob/4095f04e/ArWikiCats/translations/jobs/Jobs.py)
...
**Sources:** [ArWikiCats/translations/jobs/Jobs.py](https://github.com/ArWikiCats/ArWikiCats/blob/4095f04e/ArWikiCats/translations/jobs/Jobs.py)

 [changelog.md L268-L294](https://github.com/ArWikiCats/ArWikiCats/blob/4095f04e/changelog.md#L268-L294)

### Pattern 2: Resolver Chain Integration and Priority Order

Resolvers must be added in the correct priority order to prevent conflicts. The order is documented in [ArWikiCats/new_resolvers/__init__.py](https://github.com/ArWikiCats/ArWikiCats/blob/4095f04e/ArWikiCats/new_resolvers/__init__.py)
...
**Implementation in [ArWikiCats/new_resolvers/__init__.py](https://github.com/ArWikiCats/ArWikiCats/blob/4095f04e/ArWikiCats/new_resolvers/__init__.py)
...
**Sources:** [ArWikiCats/new_resolvers/__init__.py](https://github.com/ArWikiCats/ArWikiCats/blob/4095f04e/ArWikiCats/new_resolvers/__init__.py)

 [ArWikiCats/new_resolvers/reslove_all.py](https://github.com/ArWikiCats/ArWikiCats/blob/4095f04e/ArWikiCats/new_resolvers/reslove_all.py)

 [changelog.md L170-L200](https://github.com/ArWikiCats/ArWikiCats/blob/4095f04e/changelog.md#L170-L200)
...
From [ArWikiCats/new_resolvers/sports_resolvers/](https://github.com/ArWikiCats/ArWikiCats/blob/4095f04e/ArWikiCats/new_resolvers/sports_resolvers/)
...
From [ArWikiCats/new_resolvers/nationalities_resolvers/](https://github.com/ArWikiCats/ArWikiCats/blob/4095f04e/ArWikiCats/new_resolvers/nationalities_resolvers/)
...
Created via factory function [ArWikiCats/translations_formats/multi_data.py](https://github.com/ArWikiCats/ArWikiCats/blob/4095f04e/ArWikiCats/translations_formats/multi_data.py)
...
**Sources:** [ArWikiCats/translations_formats/DataModel/model_data_base.py](https://github.com/ArWikiCats/ArWikiCats/blob/4095f04e/ArWikiCats/translations_formats/DataModel/model_data_base.py)
...
When adding new translation data, always update [_work_files/data_len.json L1-L155](https://github.com/ArWikiCats/ArWikiCats/blob/4095f04e/_work_files/data_len.json#L1-L155)

 This file tracks dataset sizes and is used for validation:
...
**Data Structure in [ArWikiCats/translations/jobs/Jobs.py](https://github.com/ArWikiCats/ArWikiCats/blob/4095f04e/ArWikiCats/translations/jobs/Jobs.py)
...
**Gender Detection and Normalization in [ArWikiCats/new_resolvers/genders_resolvers/utils.py](https://github.com/ArWikiCats/ArWikiCats/blob/4095f04e/ArWikiCats/new_resolvers/genders_resolvers/utils.py)
...
From [ArWikiCats/new_resolvers/jobs_resolvers/mens.py](https://github.com/ArWikiCats/ArWikiCats/blob/4095f04e/ArWikiCats/new_resolvers/jobs_resolvers/mens.py)
...
**Sources:** [ArWikiCats/translations/jobs/Jobs.py](https://github.com/ArWikiCats/ArWikiCats/blob/4095f04e/ArWikiCats/translations/jobs/Jobs.py)
 ...
 [ArWikiCats/new_resolvers/genders_resolvers/utils.py](https://github.com/ArWikiCats/ArWikiCats/blob/4095f04e/ArWikiCats/new_resolvers/genders_resolvers/utils.py)
 ...
 [changelog.md L402-L432](https://github.com/ArWikiCats/ArWikiCats/blob/4095f04e/changelog.md#L402-L432)
...
**Sources:** [README.md L499-L514](https://github.com/ArWikiCats/ArWikiCats/blob/4095f04e/README.md#L499-L514)
 ...
 [changelog.md L1-L50](https://github.com/ArWikiCats/ArWikiCats/blob/4095f04e/changelog.md#L1-L50)
...
| --- | --- | --- |
| Add new translation entries | `translations/[domain]/` | [Adding Translation Data](/ArWikiCats/ArWikiCats/9.1-adding-translation-data) |
| Create new resolver | `new_resolvers/[domain]_resolvers/` | [Creating New Resolvers](/ArWikiCats/ArWikiCats/9.2-creating-new-resolvers) |
| Add test cases | `tests/test_[domain]/` | [Testing Requirements](/ArWikiCats/ArWikiCats/8-testing-and-validation) |
| Update metadata tracking | `_work_files/data_len.json` | [Adding Translation Data](/ArWikiCats/ArWikiCats/9.1-adding-translation-data) |
| Configure behavior | `ArWikiCats/config.py` | [Configuration and Environment](https://github.com/ArWikiCats/ArWikiCats/blob/4095f04e/Configuration and Environment) |
| Add helper utilities | `ArWikiCats/utils/` | [Utilities and Scripts](/ArWikiCats/ArWikiCats/9.3-code-style-and-standards) |
| Debug resolver chain | `main_processers/main_resolve.py` | [Resolution Pipeline](/ArWikiCats/ArWikiCats/3.1-resolution-pipeline) |
| Format translation patterns | `translations_formats/` | [Formatting System](/ArWikiCats/ArWikiCats/6-formatting-system) |

---

## Complete Development Example: Adding "Classical Composers" Support

This example demonstrates the full lifecycle of adding a new category type, based on actual implementation from [changelog.md L321-L331](https://github.com/ArWikiCats/ArWikiCats/blob/4095f04e/changelog.md#L321-L331)
...
EXPORT["Exported in translations/init.py:<br>from .jobs.Jobs import jobs_mens_data"]
META["Update _work_files/data_len.json:<br>jobs_mens_data: 96,552 → 96,554"]
RESOLVER["Already handled by existing resolver:<br>new_resolvers/jobs_resolvers/init.py:<br>main_jobs_resolvers(category)"]
...
**Sources:** [changelog.md L321-L331](https://github.com/ArWikiCats/ArWikiCats/blob/4095f04e/changelog.md#L321-L331)
 ...
 [ArWikiCats/new_resolvers/jobs_resolvers/](https://github.com/ArWikiCats/ArWikiCats/blob/4095f04e/ArWikiCats/new_resolvers/jobs_resolvers/)

 [tests/unit/](https://github.com/ArWikiCats/ArWikiCats/blob/4095f04e/tests/unit/)
...
* **Adding translation data and maintaining consistency**: See [Adding Translation Data](/ArWikiCats/ArWikiCats/9.1-adding-translation-data)
* **Implementing new category resolvers**: See [Creating New Resolvers](/ArWikiCats/ArWikiCats/9.2-creating-new-resolvers)
* **Using helper scripts and utilities**: See [Utilities and Scripts](/ArWikiCats/ArWikiCats/9.3-code-style-and-standards)

For understanding the broader system context:

* **System architecture and data flows**: See [Architecture](/ArWikiCats/ArWikiCats/3-architecture)
* **Resolver chain details**: See [Resolver Chain](/ArWikiCats/ArWikiCats/5-resolver-system)
* **Formatting system details**: See [Formatting System](/ArWikiCats/ArWikiCats/6-formatting-system)
* **Testing infrastructure**: See [Testing and Validation](/ArWikiCats/ArWikiCats/8-testing-and-validation)