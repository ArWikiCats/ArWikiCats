...
This page explains how to implement new resolver modules for ArWikiCats, integrate them into the resolution pipeline, and test them. For information about the overall resolution pipeline and how existing resolvers work, see [Resolution Pipeline](3.Resolution-Pipeline.md). For details about specific resolver implementations, see sections [5.1](15.Time-Pattern-Resolvers.md) through [5.7](21.Legacy-Resolvers.md).
