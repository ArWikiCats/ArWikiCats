...
This page explains how to implement new resolver modules for ArWikiCats, integrate them into the resolution pipeline, and test them. For information about the overall resolution pipeline and how existing resolvers work, see [Resolution Pipeline](/ArWikiCats/ArWikiCats/3.1-resolution-pipeline). For details about specific resolver implementations, see sections [5.1](/ArWikiCats/ArWikiCats/5.1-time-pattern-resolvers) through [5.7](/ArWikiCats/ArWikiCats/5.7-legacy-resolvers).
...
Sources: [ArWikiCats/new_resolvers/__init__.py L37-L98](https://github.com/ArWikiCats/ArWikiCats/blob/4095f04e/ArWikiCats/new_resolvers/__init__.py#L37-L98)
...
| --- | --- | --- |
| `all_new_resolvers()` | [ArWikiCats/new_resolvers/__init__.py L101-L125](https://github.com/ArWikiCats/ArWikiCats/blob/4095f04e/ArWikiCats/new_resolvers/__init__.py#L101-L125) | Main entry point, iterates through resolver chain |
| `convert_time_to_arabic()` | [ArWikiCats/time_formats/](https://github.com/ArWikiCats/ArWikiCats/blob/4095f04e/ArWikiCats/time_formats/) | First resolver: handles temporal patterns |
| `main_jobs_resolvers()` | [ArWikiCats/new_resolvers/jobs_resolvers/__init__.py L15-L38](https://github.com/ArWikiCats/ArWikiCats/blob/4095f04e/ArWikiCats/new_resolvers/jobs_resolvers/__init__.py#L15-L38) | Third resolver: job titles and occupations |
| `main_sports_resolvers()` | [ArWikiCats/new_resolvers/sports_resolvers/__init__.py L21-L47](https://github.com/ArWikiCats/ArWikiCats/blob/4095f04e/ArWikiCats/new_resolvers/sports_resolvers/__init__.py#L21-L47) | Fifth resolver: sports categories |
| `main_nationalities_resolvers()` | [ArWikiCats/new_resolvers/nationalities_resolvers/__init__.py L19-L43](https://github.com/ArWikiCats/ArWikiCats/blob/4095f04e/ArWikiCats/new_resolvers/nationalities_resolvers/__init__.py#L19-L43) | Sixth resolver: nationality-based categories |

Sources: [ArWikiCats/new_resolvers/__init__.py L37-L125](https://github.com/ArWikiCats/ArWikiCats/blob/4095f04e/ArWikiCats/new_resolvers/__init__.py#L37-L125)
...
Sources: [ArWikiCats/new_resolvers/resolve_languages/test_langs_w.py L1-L220](https://github.com/ArWikiCats/ArWikiCats/blob/4095f04e/ArWikiCats/new_resolvers/resolve_languages/test_langs_w.py#L1-L220)
...
The actual implementation pattern from [ArWikiCats/new_resolvers/sports_resolvers/raw_sports.py L306-L353](https://github.com/ArWikiCats/ArWikiCats/blob/4095f04e/ArWikiCats/new_resolvers/sports_resolvers/raw_sports.py#L306-L353)
...
Sources: [ArWikiCats/new_resolvers/sports_resolvers/raw_sports.py L306-L422](https://github.com/ArWikiCats/ArWikiCats/blob/4095f04e/ArWikiCats/new_resolvers/sports_resolvers/raw_sports.py#L306-L422)
...
The actual implementation from [ArWikiCats/new_resolvers/jobs_resolvers/mens.py L302-L324](https://github.com/ArWikiCats/ArWikiCats/blob/4095f04e/ArWikiCats/new_resolvers/jobs_resolvers/mens.py#L302-L324)
...
Sources: [ArWikiCats/new_resolvers/jobs_resolvers/mens.py L302-L366](https://github.com/ArWikiCats/ArWikiCats/blob/4095f04e/ArWikiCats/new_resolvers/jobs_resolvers/mens.py#L302-L366)
...
This follows the pattern from [ArWikiCats/new_resolvers/sports_resolvers/__init__.py L21-L52](https://github.com/ArWikiCats/ArWikiCats/blob/4095f04e/ArWikiCats/new_resolvers/sports_resolvers/__init__.py#L21-L52)

 and [ArWikiCats/new_resolvers/jobs_resolvers/__init__.py L15-L43](https://github.com/ArWikiCats/ArWikiCats/blob/4095f04e/ArWikiCats/new_resolvers/jobs_resolvers/__init__.py#L15-L43)

Sources: [ArWikiCats/new_resolvers/sports_resolvers/__init__.py L1-L52](https://github.com/ArWikiCats/ArWikiCats/blob/4095f04e/ArWikiCats/new_resolvers/sports_resolvers/__init__.py#L1-L52)

 [ArWikiCats/new_resolvers/jobs_resolvers/__init__.py L1-L43](https://github.com/ArWikiCats/ArWikiCats/blob/4095f04e/ArWikiCats/new_resolvers/jobs_resolvers/__init__.py#L1-L43)

 [ArWikiCats/new_resolvers/nationalities_resolvers/__init__.py L1-L48](https://github.com/ArWikiCats/ArWikiCats/blob/4095f04e/ArWikiCats/new_resolvers/nationalities_resolvers/__init__.py#L1-L48)
...
The resolver chain order is critical and documented in the priority notes. Key rules from [ArWikiCats/new_resolvers/__init__.py L36-L98](https://github.com/ArWikiCats/ArWikiCats/blob/4095f04e/ArWikiCats/new_resolvers/__init__.py#L36-L98)
...
Sources: [ArWikiCats/new_resolvers/__init__.py L30-L125](https://github.com/ArWikiCats/ArWikiCats/blob/4095f04e/ArWikiCats/new_resolvers/__init__.py#L30-L125)
...
Sources: [ArWikiCats/new_resolvers/__init__.py L1-L125](https://github.com/ArWikiCats/ArWikiCats/blob/4095f04e/ArWikiCats/new_resolvers/__init__.py#L1-L125)
...
Sources: [tests/new_resolvers/resolve_languages/test_langs_slow.py L1-L85](https://github.com/ArWikiCats/ArWikiCats/blob/4095f04e/tests/new_resolvers/resolve_languages/test_langs_slow.py#L1-L85)

 [tests/new_resolvers/resolve_languages/test_langs_w.py L1-L220](https://github.com/ArWikiCats/ArWikiCats/blob/4095f04e/tests/new_resolvers/resolve_languages/test_langs_w.py#L1-L220)
...
Sources: [README.md L449-L482](https://github.com/ArWikiCats/ArWikiCats/blob/4095f04e/README.md#L449-L482)
...
Sources: [changelog.md L39-L43](https://github.com/ArWikiCats/ArWikiCats/blob/4095f04e/changelog.md#L39-L43)
...
Sources: [changelog.md L37](https://github.com/ArWikiCats/ArWikiCats/blob/4095f04e/changelog.md#L37-L37)

 [ArWikiCats/translations_formats/formats_logger.py L1-L10](https://github.com/ArWikiCats/ArWikiCats/blob/4095f04e/ArWikiCats/translations_formats/formats_logger.py#L1-L10)
...
Sources: [ArWikiCats/main_processers/event_lab_bot.py L342-L348](https://github.com/ArWikiCats/ArWikiCats/blob/4095f04e/ArWikiCats/main_processers/event_lab_bot.py#L342-L348)
...
Sources: [ArWikiCats/config.py L1-L58](https://github.com/ArWikiCats/ArWikiCats/blob/4095f04e/ArWikiCats/config.py#L1-L58)
 ...
 [README.md L243-L266](https://github.com/ArWikiCats/ArWikiCats/blob/4095f04e/README.md#L243-L266)
...
Sources: [README.md L273-L290](https://github.com/ArWikiCats/ArWikiCats/blob/4095f04e/README.md#L273-L290)
...
1. **Main Entry Point** at [ArWikiCats/new_resolvers/jobs_resolvers/__init__.py L15-L38](https://github.com/ArWikiCats/ArWikiCats/blob/4095f04e/ArWikiCats/new_resolvers/jobs_resolvers/__init__.py#L15-L38) : * Tries mens resolver first * Falls back to womens resolver * Finally tries religious jobs resolver
2. **Mens Resolver** at [ArWikiCats/new_resolvers/jobs_resolvers/mens.py L327-L366](https://github.com/ArWikiCats/ArWikiCats/blob/4095f04e/ArWikiCats/new_resolvers/jobs_resolvers/mens.py#L327-L366) : * Uses `MultiDataFormatterBaseV2` with: * `jobs_mens_data` (96,552 entries) * `All_Nat` nationality data * Handles suffix patterns via `resolve_sport_category_suffix_with_mapping()` * Explicitly skips categories that are country/nationality names
3. **Formatted Data Patterns** from [ArWikiCats/new_resolvers/jobs_resolvers/mens.py L114-L254](https://github.com/ArWikiCats/ArWikiCats/blob/4095f04e/ArWikiCats/new_resolvers/jobs_resolvers/mens.py#L114-L254) : * Base patterns: `{en_nat}`, `{en_job}` * Combined patterns: `{en_nat} {en_job}`, `{en_nat} expatriate {en_job}` * Gender-specific keys generated via `nat_and_gender_keys()`
...
Sources: [ArWikiCats/new_resolvers/jobs_resolvers/__init__.py L1-L43](https://github.com/ArWikiCats/ArWikiCats/blob/4095f04e/ArWikiCats/new_resolvers/jobs_resolvers/__init__.py#L1-L43)

 [ArWikiCats/new_resolvers/jobs_resolvers/mens.py L302-L375](https://github.com/ArWikiCats/ArWikiCats/blob/4095f04e/ArWikiCats/new_resolvers/jobs_resolvers/mens.py#L302-L375)
...
* **Main entry function** named `main_*_resolvers(normalized_category)` following pattern from [ArWikiCats/new_resolvers/jobs_resolvers/__init__.py L15](https://github.com/ArWikiCats/ArWikiCats/blob/4095f04e/ArWikiCats/new_resolvers/jobs_resolvers/__init__.py#L15-L15)
...
* **Added to _RESOLVER_CHAIN** in [ArWikiCats/new_resolvers/__init__.py](https://github.com/ArWikiCats/ArWikiCats/blob/4095f04e/ArWikiCats/new_resolvers/__init__.py)
...
Sources: [changelog.md L1-L50](https://github.com/ArWikiCats/ArWikiCats/blob/4095f04e/changelog.md#L1-L50)
...
Sources: [ArWikiCats/main_processers/main_resolve.py L1-L156](https://github.com/ArWikiCats/ArWikiCats/blob/4095f04e/ArWikiCats/main_processers/main_resolve.py#L1-L156)
 ...
 [ArWikiCats/main_processers/event_lab_bot.py L1-L382](https://github.com/ArWikiCats/ArWikiCats/blob/4095f04e/ArWikiCats/main_processers/event_lab_bot.py#L1-L382)

 [README.md L269-L344](https://github.com/ArWikiCats/ArWikiCats/blob/4095f04e/README.md#L269-L344)

 [tests/new_resolvers/resolve_languages/test_langs_slow.py L1-L85](https://github.com/ArWikiCats/ArWikiCats/blob/4095f04e/tests/new_resolvers/resolve_languages/test_langs_slow.py#L1-L85)

 [tests/new_resolvers/resolve_languages/test_langs_w.py L1-L220](https://github.com/ArWikiCats/ArWikiCats/blob/4095f04e/tests/new_resolvers/resolve_languages/test_langs_w.py#L1-L220)

 [ArWikiCats/config.py L1-L58](https://github.com/ArWikiCats/ArWikiCats/blob/4095f04e/ArWikiCats/config.py#L1-L58)

 [ArWikiCats/translations_formats/formats_logger.py L1-L10](https://github.com/ArWikiCats/ArWikiCats/blob/4095f04e/ArWikiCats/translations_formats/formats_logger.py#L1-L10)

 [changelog.md L1-L600](https://github.com/ArWikiCats/ArWikiCats/blob/4095f04e/changelog.md#L1-L600)