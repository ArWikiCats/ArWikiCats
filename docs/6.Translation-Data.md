...
For information about how this data is processed and aggregated, see [Data Aggregation Pipeline](7.Data-Aggregation-Pipeline.md). For details about specific resolvers that consume this data, see [Resolver System](14.Resolver-System.md).
...
* For detailed aggregation pipelines, see [Data Aggregation Pipeline](7.Data-Aggregation-Pipeline.md)
* For geographic data specifics, see [Geographic Data](8.Geographic-Data.md)
* For jobs data structures, see [Jobs and Occupations](9.Jobs-and-Occupations.md)
* For nationality handling, see [Nationalities](10.Nationalities.md)
* For sports translations, see [Sports Data](11.Sports-Data.md)
* For media categories, see [Films and Television](12.Films-and-Television.md)
* For how resolvers consume this data, see [Resolver System](14.Resolver-System.md)