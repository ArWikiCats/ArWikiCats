...
For nationality-based category resolution, see [Nationalities](/ArWikiCats/ArWikiCats/4.4-nationalities). For country-based resolvers, see [Country Name Resolvers](/ArWikiCats/ArWikiCats/5.3-country-name-resolvers).
