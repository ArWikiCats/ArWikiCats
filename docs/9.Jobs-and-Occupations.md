...
For resolver implementation details using these datasets, see [Job Resolvers](/ArWikiCats/ArWikiCats/5.4-job-resolvers). For nationality handling in job categories, see [Nationality Resolvers](/ArWikiCats/ArWikiCats/5.2-nationality-resolvers).
...
subgraph subGraph2 ["Data Builders"]
    BuildJobs
    BuildWomens
    BuildJobsNew
...
subgraph subGraph1 ["Specialized Job Data"]
    Religious
    Sports
    Singers
    Players
...
subgraph subGraph0 ["Raw Job Sources"]
    jobs_json
    Jobs_22
    jobs_3
    jobs_pp
...
**Sources:** [ArWikiCats/translations/jobs/Jobs.py L1-L211](https://github.com/ArWikiCats/ArWikiCats/blob/4095f04e/ArWikiCats/translations/jobs/Jobs.py#L1-L211)

 [_work_files/data_len.json L9-L14](https://github.com/ArWikiCats/ArWikiCats/blob/4095f04e/_work_files/data_len.json#L9-L14)
...
subgraph subGraph4 ["Stage 5: Final Assembly"]
    Finalise
    SplitGender
    Finalise --> SplitGender
end

subgraph subGraph3 ["Stage 4: Apply Transformations"]
    AddExecutive
    AddDisability
    AddCompanies
    AddActivists
...
subgraph subGraph2 ["Stage 3: Merge Specialized Data"]
    MergeReligious
    MergeSingers
    MergePlayers
    MergeSports
...
subgraph subGraph1 ["Stage 2: Generate Variants"]
    SportVariants
    PeopleVariants
end

subgraph subGraph0 ["Stage 1: Load Base Data"]
    LoadPrimary
    LoadAdditional
    LoadPP
end
...
**Sources:** [ArWikiCats/translations/jobs/Jobs.py L150-L183](https://github.com/ArWikiCats/ArWikiCats/blob/4095f04e/ArWikiCats/translations/jobs/Jobs.py#L150-L183)

 [ArWikiCats/translations/data_builders/build_jobs.py](https://github.com/ArWikiCats/ArWikiCats/blob/4095f04e/ArWikiCats/translations/data_builders/build_jobs.py)
...
**Sources:** [ArWikiCats/translations/jobs/Jobs.py L158-L179](https://github.com/ArWikiCats/ArWikiCats/blob/4095f04e/ArWikiCats/translations/jobs/Jobs.py#L158-L179)
...
TypeDef --> GenderedLabelMap

subgraph subGraph3 ["Dual-Gender Access"]
    GenderedLabelMap
    RELIGIOUS_KEYS_PP
    PLAYERS_TO_MEN_WOMENS
    MEN_WOMENS_SINGERS
...
subgraph subGraph0 ["GenderedLabel Structure"]
    TypeDef
end

subgraph subGraph2 ["Female-Only Access"]
    jobs_womens_data
    short_womens
end

subgraph subGraph1 ["Male-Only Access"]
    jobs_mens_data
    Jobs_new
end
```
...
**Sources:** [ArWikiCats/translations/jobs/Jobs.py L181-L183](https://github.com/ArWikiCats/ArWikiCats/blob/4095f04e/ArWikiCats/translations/jobs/Jobs.py#L181-L183)
 ...
 [_work_files/data_len.json L9-L15](https://github.com/ArWikiCats/ArWikiCats/blob/4095f04e/_work_files/data_len.json#L9-L15)
...
subgraph subGraph2 ["Builder Functions"]
    BuildReligious
end

subgraph subGraph1 ["Religious Role Types"]
    BaseRoles
    DenomRoles
    FunctionRoles
end

subgraph subGraph0 ["Religious Data Sources"]
    RELIGIOUS_KEYS_PP
...
**Sources:** [ArWikiCats/translations/jobs/jobs_data_basic.py L20-L54](https://github.com/ArWikiCats/ArWikiCats/blob/4095f04e/ArWikiCats/translations/jobs/jobs_data_basic.py#L20-L54)

 [ArWikiCats/translations/jobs/jobs_data_basic.py L83-L98](https://github.com/ArWikiCats/ArWikiCats/blob/4095f04e/ArWikiCats/translations/jobs/jobs_data_basic.py#L83-L98)
...
subgraph subGraph2 ["Final Sport Jobs"]
    SPORT_JOB_VARIANTS
    PLAYERS_TO_MEN_WOMENS
end

subgraph subGraph1 ["Player Role Builders"]
    TeamSports
    BoxingLabels
    SkatingLabels
    GeneralScope
...
subgraph subGraph0 ["Sport Job Components"]
    SPORTS_KEYS
    FOOTBALL_KEYS
    JOBS_PLAYERS
end
...
**Sources:** [ArWikiCats/translations/jobs/jobs_players_list.py L1-L263](https://github.com/ArWikiCats/ArWikiCats/blob/4095f04e/ArWikiCats/translations/jobs/jobs_players_list.py#L1-L263)

 [_work_files/data_len.json L32-L46](https://github.com/ArWikiCats/ArWikiCats/blob/4095f04e/_work_files/data_len.json#L32-L46)
...
subgraph subGraph2 ["Final Singer Datasets"]
    MEN_WOMENS_SINGERS_BASED
    MEN_WOMENS_SINGERS
    MEN_WOMENS_SINGERS_BASED --> MEN_WOMENS_SINGERS
end

subgraph subGraph1 ["Singer Builders"]
    BuildSingerVariants
    BuildNonFiction
end

subgraph subGraph0 ["Singer Data Components"]
    SINGERS_TAB
    FILMS_TYPE
    SINGERS_AFTER_ROLES
    NON_FICTION_TOPICS
...
**Sources:** [ArWikiCats/translations/jobs/jobs_singers.py L1-L148](https://github.com/ArWikiCats/ArWikiCats/blob/4095f04e/ArWikiCats/translations/jobs/jobs_singers.py#L1-L148)

 [_work_files/data_len.json L41-L64](https://github.com/ArWikiCats/ArWikiCats/blob/4095f04e/_work_files/data_len.json#L41-L64)
...
**Sources:** [ArWikiCats/translations/jobs/Jobs2.py L21-L88](https://github.com/ArWikiCats/ArWikiCats/blob/4095f04e/ArWikiCats/translations/jobs/Jobs2.py#L21-L88)
...
subgraph subGraph0 ["Artist Components"]
    PAINTER_STYLES
    PAINTER_ROLES
    PAINTER_CATEGORIES
end
...
**Sources:** [ArWikiCats/translations/jobs/jobs_data_basic.py L102-L126](https://github.com/ArWikiCats/ArWikiCats/blob/4095f04e/ArWikiCats/translations/jobs/jobs_data_basic.py#L102-L126)
...
**Sources:** [ArWikiCats/translations/jobs/Jobs.py L32-L67](https://github.com/ArWikiCats/ArWikiCats/blob/4095f04e/ArWikiCats/translations/jobs/Jobs.py#L32-L67)

 [_work_files/data_len.json L114](https://github.com/ArWikiCats/ArWikiCats/blob/4095f04e/_work_files/data_len.json#L114-L114)
...
subgraph subGraph2 ["Formatter Creation"]
    CreateBot
    Templates
    Templates --> CreateBot
end
...
**Sources:** [ArWikiCats/new_resolvers/jobs_resolvers/mens.py L114-L254](https://github.com/ArWikiCats/ArWikiCats/blob/4095f04e/ArWikiCats/new_resolvers/jobs_resolvers/mens.py#L114-L254)

 [ArWikiCats/new_resolvers/jobs_resolvers/mens.py L303-L325](https://github.com/ArWikiCats/ArWikiCats/blob/4095f04e/ArWikiCats/new_resolvers/jobs_resolvers/mens.py#L303-L325)
...
subgraph subGraph3 ["Resolution Output"]
    FemaleResult
end

subgraph subGraph2 ["Female Templates"]
    FemaleTemplates
end

subgraph subGraph1 ["Two-Stage Resolution"]
    Stage1
    Stage2
    Stage1 --> Stage2
end

subgraph subGraph0 ["Female Resolver Pipeline"]
    InputFemale
    CheckMale
...
**Sources:** [ArWikiCats/new_resolvers/jobs_resolvers/womens.py L91-L186](https://github.com/ArWikiCats/ArWikiCats/blob/4095f04e/ArWikiCats/new_resolvers/jobs_resolvers/womens.py#L91-L186)

 [ArWikiCats/new_resolvers/jobs_resolvers/womens.py L230-L278](https://github.com/ArWikiCats/ArWikiCats/blob/4095f04e/ArWikiCats/new_resolvers/jobs_resolvers/womens.py#L230-L278)
...
**Sources:** [ArWikiCats/translations/jobs/jobs_data_basic.py L56-L82](https://github.com/ArWikiCats/ArWikiCats/blob/4095f04e/ArWikiCats/translations/jobs/jobs_data_basic.py#L56-L82)

 [_work_files/data_len.json L99](https://github.com/ArWikiCats/ArWikiCats/blob/4095f04e/_work_files/data_len.json#L99-L99)
...
**Sources:** [ArWikiCats/new_resolvers/jobs_resolvers/utils.py L10-L26](https://github.com/ArWikiCats/ArWikiCats/blob/4095f04e/ArWikiCats/new_resolvers/jobs_resolvers/utils.py#L10-L26)
...
**Sources:** [ArWikiCats/new_resolvers/jobs_resolvers/mens.py L89-L111](https://github.com/ArWikiCats/ArWikiCats/blob/4095f04e/ArWikiCats/new_resolvers/jobs_resolvers/mens.py#L89-L111)

 [ArWikiCats/new_resolvers/jobs_resolvers/womens.py L68-L87](https://github.com/ArWikiCats/ArWikiCats/blob/4095f04e/ArWikiCats/new_resolvers/jobs_resolvers/womens.py#L68-L87)
...
| --- | --- | --- |
| `jobs_mens_data` | [ArWikiCats/translations/jobs/Jobs.py L181](https://github.com/ArWikiCats/ArWikiCats/blob/4095f04e/ArWikiCats/translations/jobs/Jobs.py#L181-L181) | Primary male job resolver lookup |
| `jobs_womens_data` | [ArWikiCats/translations/jobs/Jobs.py L182](https://github.com/ArWikiCats/ArWikiCats/blob/4095f04e/ArWikiCats/translations/jobs/Jobs.py#L182-L182) | Primary female job resolver lookup |
| `Jobs_new` | [ArWikiCats/translations/jobs/Jobs.py L183](https://github.com/ArWikiCats/ArWikiCats/blob/4095f04e/ArWikiCats/translations/jobs/Jobs.py#L183-L183) | Extended jobs with nationality variants |
| `RELIGIOUS_KEYS_PP` | [ArWikiCats/translations/jobs/jobs_data_basic.py L20](https://github.com/ArWikiCats/ArWikiCats/blob/4095f04e/ArWikiCats/translations/jobs/jobs_data_basic.py#L20-L20) | Religious role patterns |
| `SPORT_JOB_VARIANTS` | [ArWikiCats/translations/jobs/jobs_players_list.py L202](https://github.com/ArWikiCats/ArWikiCats/blob/4095f04e/ArWikiCats/translations/jobs/jobs_players_list.py#L202-L202) | Sport-specific job variants |
| `short_womens_jobs` | [ArWikiCats/translations/jobs/jobs_womens.py L75](https://github.com/ArWikiCats/ArWikiCats/blob/4095f04e/ArWikiCats/translations/jobs/jobs_womens.py#L75-L75) | Core female-specific jobs |

### Aggregate Exports

Via [ArWikiCats/translations/__init__.py L15-L26](https://github.com/ArWikiCats/ArWikiCats/blob/4095f04e/ArWikiCats/translations/__init__.py#L15-L26)
...
**Sources:** [ArWikiCats/translations/__init__.py L15-L26](https://github.com/ArWikiCats/ArWikiCats/blob/4095f04e/ArWikiCats/translations/__init__.py#L15-L26)

 [ArWikiCats/translations/jobs/Jobs.py L206-L210](https://github.com/ArWikiCats/ArWikiCats/blob/4095f04e/ArWikiCats/translations/jobs/Jobs.py#L206-L210)
...
subgraph subGraph2 ["Bot Creation Cache"]
    BotCache
    LoadBotCache
    BotCache --> LoadBotCache
end

subgraph subGraph1 ["Data Load Cache"]
    DataCache
    LoadJobsCache
    LoadNatsCache
    LoadFormattedCache
...
subgraph subGraph0 ["Resolver Cache"]
    ResolverCache
    MensCache
    WomensCache
...
**Sources:** [ArWikiCats/new_resolvers/jobs_resolvers/mens.py L114-L327](https://github.com/ArWikiCats/ArWikiCats/blob/4095f04e/ArWikiCats/new_resolvers/jobs_resolvers/mens.py#L114-L327)

 [ArWikiCats/new_resolvers/jobs_resolvers/womens.py L90-L302](https://github.com/ArWikiCats/ArWikiCats/blob/4095f04e/ArWikiCats/new_resolvers/jobs_resolvers/womens.py#L90-L302)
