...
**Sources:** [ArWikiCats/translations/jobs/jobs_data_basic.py L56-L82](../ArWikiCats/translations/jobs/jobs_data_basic.py#L56-L82)
 ...
 [_work_files/data_len.json L99](../_work_files/data_len.json#L99-L99)
...
| --- | --- | --- |
| `jobs_mens_data` | [ArWikiCats/translations/jobs/Jobs.py L181](../ArWikiCats/translations/jobs/Jobs.py#L181-L181) | Primary male job resolver lookup |
| `jobs_womens_data` | [ArWikiCats/translations/jobs/Jobs.py L182](../ArWikiCats/translations/jobs/Jobs.py#L182-L182) | Primary female job resolver lookup |
| `Jobs_new` | [ArWikiCats/translations/jobs/Jobs.py L183](../ArWikiCats/translations/jobs/Jobs.py#L183-L183) | Extended jobs with nationality variants |
| `RELIGIOUS_KEYS_PP` | [ArWikiCats/translations/jobs/jobs_data_basic.py L20](../ArWikiCats/translations/jobs/jobs_data_basic.py#L20-L20) | Religious role patterns |
| `SPORT_JOB_VARIANTS` | [ArWikiCats/translations/jobs/jobs_players_list.py L202](../ArWikiCats/translations/jobs/jobs_players_list.py#L202-L202) | Sport-specific job variants |
| `short_womens_jobs` | [ArWikiCats/translations/jobs/jobs_womens.py L75](../ArWikiCats/translations/jobs/jobs_womens.py#L75-L75) | Core female-specific jobs |
