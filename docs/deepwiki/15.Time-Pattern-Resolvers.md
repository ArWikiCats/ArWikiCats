...
| --- | --- | --- |
| `Try_With_Years()` | Primary year pattern handler; detects year position and constructs Arabic label | [with_years_bot.py L220-L258](../../ArWikiCats/legacy_bots/legacy_resolvers_bots/with_years_bot.py#L220-L258) |
| `label_for_startwith_year_or_typeo()` | Handles categories starting with years; includes country/relation resolution | [year_or_typeo.py L302-L313](../../ArWikiCats/legacy_bots/legacy_resolvers_bots/year_or_typeo.py#L302-L313) |
| `wrap_try_with_years()` | Wrapper that pre-filters and normalizes before calling `Try_With_Years()` | [with_years_bot.py L261-L285](../../ArWikiCats/legacy_bots/legacy_resolvers_bots/with_years_bot.py#L261-L285) |
...
**Sources:** [README.md L82-L86](./README.md#L82-L86L86), [examples/run.py L42-L44](../../examples/run.py#L42-L44)
