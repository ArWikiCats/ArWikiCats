...
* For using helper scripts and utilities, see [Utilities and Scripts](40.Code-Style-and-Standards.md)
...
**Sources:** [changelog.md L1-L80](../../changelog.md#L1-L80), [README.md L449-L51./README.md#L449-L5149-L514), [ArWikiCats/new_resolvers/reslove_all.py](../../ArWikiCats/new_resolvers/reslove_all.py), [tests/](../../tests)
...
1. **Chain of Responsibility**: `new_resolvers_all()` tries resolvers in priority order until match found [new_resolvers/reslove_all.py](../../ArWikiCats/new_resolvers/reslove_all.py)
2. **Template Method**: `FormatDataBase` defines abstract interface, subclasses implement search logic [translations_formats/DataModel/model_data_base.py](../../ArWikiCats/translations_formats/DataModel/model_data_base.py)
3. **Factory Pattern**: `format_multi_data()`, `format_year_country_data()` create configured formatter instances [translations_formats/multi_data.py](../../ArWikiCats/translations_formats/multi_data.py)
...
**Sources:** [tests/unit/](../../tests/unit), [tests/integration/](../../tests/integration), [tests/e2e/](../../tests/e2e), [tests/utils/dump_runner.py](../../tests/utils/dump_runner.py), [changelog.md L1-L110](../../changelog.md#L1-L110), [README.md./README.md#L442-L469ME.md#L442-L469)
...
**Sources:** [tests/event_lists/test_defunct.py L1-L74](../../tests/event_lists/test_defunct.py#L1-L74), [README.md L449-L48./README.md#L449-L4839-L483), [changelog.md L205-L220](../../changelog.md#L205-L220)
...
**Sources:** [README.md L499-L514](./README.md#L499-L514514), [changelog.md L42-L47](../../changelog.md#L42-L47)
...
When adding new translation data, always update [_work_files/data_len.json L1-L155](../../_work_files/data_len.json#L1-L155)
...
**Sources:** [README.md L499-L514](./README.md#L499-L514514), [changelog.md L1-L50](../../changelog.md#L1-L50)
...
| Add test cases | `tests/test_[domain]/` | [Testing Requirements](32.Testing-and-Validation.md) |
| Update metadata tracking | `_work_files/data_len.json` | [Adding Translation Data](38.Adding-Translation-Data.md) |
| Configure behavior | `ArWikiCats/config.py` | [Configuration and Environment](`#configuration-and-environment`) |
| Add helper utilities | `ArWikiCats/utils/` | [Utilities and Scripts](40.Code-Style-and-Standards.md) |
...
* **Using helper scripts and utilities**: See [Utilities and Scripts](40.Code-Style-and-Standards.md)

For understanding the broader system context:

* **System architecture and data flows**: See [Architecture](2.Architecture.md)
* **Resolver chain details**: See [Resolver Chain](14.Resolver-System.md)
