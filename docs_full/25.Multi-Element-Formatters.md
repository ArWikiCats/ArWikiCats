...
This page documents the classes that orchestrate two Single Element Formatters (see [Single Element Formatters](24.Single-Element-Formatters.md)) to handle these complex translations. For information about the base formatting infrastructure, see [Format Data Models](#6.1). For placeholder syntax and substitution logic, see [Template and Placeholder System](26.Template-and-Placeholder-System.md)
