"""Translation tables for city names."""

from __future__ import annotations

import logging

from ._shared import load_json_mapping, log_mapping_stats, merge_mappings, normalize_to_lower
...
CITY_TRANSLATIONS = merge_mappings(
    load_json_mapping("all_cities"),
    load_json_mapping("Cities_tab2"),
    CITY_OVERRIDES,
)
CITY_LABEL_PATCHES = load_json_mapping("yy2")
CITY_TRANSLATIONS_LOWER = normalize_to_lower(CITY_TRANSLATIONS)

log_mapping_stats(
    "cities",
    translations=CITY_TRANSLATIONS,
    label_patches=CITY_LABEL_PATCHES,
    lower_translations=CITY_TRANSLATIONS_LOWER,
)


def get_city_translations() -> dict[str, str]:
    """Return a copy of the city translation table."""

    return dict(CITY_TRANSLATIONS)


def get_city_label_patches() -> dict[str, str]:
    """Return a copy of the supplemental label table."""

    return dict(CITY_LABEL_PATCHES)


def get_city_translations_lower() -> dict[str, str]:
    """Return the lower-cased translation table."""

    return dict(CITY_TRANSLATIONS_LOWER)
