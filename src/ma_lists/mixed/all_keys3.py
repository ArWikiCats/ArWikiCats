...
TYPE_TABLE_7_BASE: Final[dict[str, str]] = {
    "air force": "قوات جوية",
...
ALBUMS_TYPE: Final[dict[str, str]] = {
...
BUSINESSPEOPLE_INDUSTRIES: Final[dict[str, str]] = {
...
FILM_PRODUCTION_COMPANY: Final[dict[str, str]] = {
    "Yash Raj": "ياش راج",
...
NN_TABLE_GENDERED: Final[dict[str, dict[str, str]]] = {
...
albums_type: dict[str, str] = dict(ALBUMS_TYPE)

film_production_company: dict[str, str] = dict(FILM_PRODUCTION_COMPANY)
