...
COUNTRY_YEAR_DATA ={
    ...
    "Category:{YEAR1} murders in {COUNTRY1}": "تصنيف:جرائم قتل في {COUNTRY1} {YEAR1}",  # 2076
    "Category:{YEAR1} disasters in {COUNTRY1}": "تصنيف:كوارث في {COUNTRY1} {YEAR1}",  # 2140
    ...
    "Category:{YEAR1} mass shootings in {COUNTRY1}": "تصنيف:إطلاق نار عشوائي في {COUNTRY1} {YEAR1}",  # 215
    ...
    "Category:{YEAR1} religious buildings and structures in {COUNTRY1}": "تصنيف:مبان ومنشآت دينية في {COUNTRY1} {YEAR1}",  # 165
    "Category:{YEAR1} churches in {COUNTRY1}": "تصنيف:كنائس في {COUNTRY1} {YEAR1}",  # 172
    ...
    "Category:{YEAR1} mosques in {COUNTRY1}": "تصنيف:مساجد في {COUNTRY1} {YEAR1}",  # 175
    ...
    "Category:{YEAR1} fires in {COUNTRY1}": "تصنيف:حرائق في {COUNTRY1} {YEAR1}",  # 120
    ...
    "Category:{YEAR1} Roman Catholic archbishops in {COUNTRY1}": "تصنيف:رؤساء أساقفة رومان كاثوليك في {COUNTRY1} {YEAR1}",  # 129
    ...
    "Category:{YEAR1} Tour de {COUNTRY1}": "تصنيف:سباق طواف {COUNTRY1} {YEAR1}",  # 110
    ...
    "Category:{YEAR1} Roman Catholic church buildings in {COUNTRY1}": "تصنيف:مبان كنائس رومانية كاثوليكية في {COUNTRY1} {YEAR1}",  # 92
    "Category:{YEAR1} in Ottoman {COUNTRY1}": "تصنيف:{COUNTRY1} العثمانية في {YEAR1}",  # 65
    "Category:{YEAR1} natural disasters in {COUNTRY1}": "تصنيف:كوارث طبيعية في {COUNTRY1} {YEAR1}",  # 84
    "Category:{YEAR1} floods in {COUNTRY1}": "تصنيف:فيضانات في {COUNTRY1} {YEAR1}",  # 62
    ...
    "Category:{YEAR1} {COUNTRY1} elections": "تصنيف:انتخابات {COUNTRY1} {YEAR1}",  # 79
    "Category:Candidates in the {YEAR1} {COUNTRY1} elections": "تصنيف:مرشحون في انتخابات {COUNTRY1} {YEAR1}",  # 73
    "Category:{YEAR1} military history of {COUNTRY1}": "تصنيف:تاريخ {COUNTRY1} العسكري في {YEAR1}",  # 57
    "Category:{YEAR1} controversies in {COUNTRY1}": "تصنيف:خلافات في {COUNTRY1} {YEAR1}",  # 53
    ...
    "Category:{YEAR1} {COUNTRY1} state court judges": "تصنيف:قضاة محكمة ولاية {COUNTRY1} {YEAR1}",  # 54
}
