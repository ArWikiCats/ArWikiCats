...
def load_sources() -> Dict[str, NationalityEntry]:
    ...
    raw_all_nat_o: Dict[str, Any] = open_json_file("nationalities/All_Nat_o") or {}
    raw_uu_nats: Dict[str, Any] = open_json_file("nationalities/uu_nats") or {}
    raw_sub_nat: Dict[str, Any] = open_json_file("nationalities/Sub_Nat") or {}
