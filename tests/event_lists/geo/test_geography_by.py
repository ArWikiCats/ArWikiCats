...
test_data = [
    ("geography_by_1", geography_by_1),
    ("geography_by_2", geography_by_2),
    ("geography_by_3", geography_by_3),
    ("geography_by_4", geography_by_4),
    ("geography_by_5", geography_by_5),
]


@pytest.mark.parametrize("name,data", test_data)
def test_geography_by(name, data):
