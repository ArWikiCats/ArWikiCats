...
data1 = {
    ...
    "Category:Films by city of shooting": "تصنيف:أفلام حسب مدينة التصوير",
...
data2 = {
    ...
    "Category:Television series by country of shooting": "تصنيف:مسلسلات تلفزيونية حسب بلد التصوير",
