...
data0 = {
    "yemeni abortion law": "قانون الإجهاض اليمني",
    "yemeni amateur football league": "الدوري اليمني لكرة القدم للهواة",
    "yemeni army": "الجيش اليمني",
    "yemeni census": "التعداد اليمني",
    "yemeni criminal law": "القانون الجنائي اليمني",
    "yemeni elite cup": "كأس النخبة اليمني",
    "yemeni family law": "قانون الأسرة اليمني",
    ...
    "yemeni invasion": "الغزو اليمني",
    "yemeni involvement": "التدخل اليمني",
    "yemeni labour law": "قانون العمل اليمني",
    ...
    "yemeni military": "الجيش اليمني",
    "yemeni national party": "الحزب الوطني اليمني",
    "yemeni national super league": "دوري السوبر اليمني",
    ...
    "yemeni pardons": "العفو اليمني",
    "yemeni population and housing census": "التعداد اليمني للسكان والمساكن",
    "yemeni population census": "التعداد السكاني اليمني",
    "yemeni premier division": "الدوري اليمني الممتاز",
    "yemeni premier league": "الدوري اليمني الممتاز",
    "yemeni president cup": "كأس الرئيس اليمني",
    "yemeni presidential pardons": "العفو الرئاسي اليمني",
    "yemeni professional league": "دوري المحترفين اليمني",
    "yemeni professional league managers": "مدربو دوري المحترفين اليمني",
    ...
    "yemeni referendum": "الاستفتاء اليمني",
    "yemeni rugby league administrators": "مدراء الدوري اليمني للرجبي",
    "yemeni rugby league players": "لاعبو الدوري اليمني للرجبي",
    "yemeni rugby league playerss": "لاعبو الدوري اليمني للرجبي",
    "yemeni rugby union leagues": "اتحاد دوري الرجبي اليمني",
    "yemeni solidarity movement": "حركة التضامن اليمني",
    "yemeni super cup": "كأس السوبر اليمني",
    "yemeni super league": "دوري السوبر اليمني",
