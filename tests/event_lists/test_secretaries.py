...
secretaries_test_1 = {
    ...
    "Category:Secretaries of environment and natural resources of the Philippines": "تصنيف:وزراء بيئة وموارد طبيعية في الفلبين",
    ...
    "Category:Secretaries of labor and employment of the Philippines": "تصنيف:وزراء في عمالة والتوظيف في الفلبين",
    ...
    "Category:Secretaries of state for India": "تصنيف:وزراء الدولة لشؤون الهند",
    "Category:Secretaries of state for Northern Ireland": "تصنيف:وزراء الدولة لشؤون أيرلندا الشمالية",
    "Category:Secretaries of state for Scotland": "تصنيف:وزراء الدولة لإسكتلندا",
    "Category:Secretaries of state for Wales": "تصنيف:وزراء الدولة لشؤون ويلز",
    "Category:Secretaries of state for defence (UK)": "تصنيف:وزراء دفاع بريطانيون",
    "Category:Secretaries of state for social services": "تصنيف:وزراء الدولة للصحة والخدمات الاجتماعية",
    "Category:Secretaries of state for the European Union": "تصنيف:وزير دولة للاتحاد الأوروبي",
    "Category:Secretaries of state for the colonies": "تصنيف:وزراء الدولة للمستعمرات",
    "Category:Secretaries of state for transport of San Marino": "تصنيف:وزير خارجية في نقل في سان مارينو",
    "Category:Secretaries of state of Alabama": "تصنيف:وزير خارجية ألاباما",
    "Category:Secretaries of state of Arizona": "تصنيف:وزير خارجية أريزونا",
    "Category:Secretaries of state of Arkansas": "تصنيف:وزير خارجية أركنساس",
    "Category:Secretaries of state of California": "تصنيف:وزير خارجية كاليفورنيا",
    "Category:Secretaries of state of Colorado": "تصنيف:وزير خارجية كولورادو",
    "Category:Secretaries of state of Delaware": "تصنيف:وزير خارجية ديلوير",
    "Category:Secretaries of state of Florida": "تصنيف:وزير خارجية فلوريدا",
    "Category:Secretaries of state of Georgia (U.S. state)": "تصنيف:وزير خارجية ولاية جورجيا",
    "Category:Secretaries of state of Idaho": "تصنيف:وزير خارجية أيداهو",
    "Category:Secretaries of state of Illinois": "تصنيف:وزير خارجية إلينوي",
    "Category:Secretaries of state of Indiana": "تصنيف:وزير خارجية إنديانا",
    "Category:Secretaries of state of Iowa": "تصنيف:وزير خارجية آيوا",
    "Category:Secretaries of state of Kansas": "تصنيف:وزير خارجية كانساس",
    ...
    "Category:Secretaries of state of Maine": "تصنيف:وزير خارجية مين",
    "Category:Secretaries of state of Maryland": "تصنيف:وزير خارجية ماريلند",
    "Category:Secretaries of state of Michigan": "تصنيف:وزير خارجية ميشيغان",
    "Category:Secretaries of state of Minnesota": "تصنيف:وزير خارجية مينيسوتا",
    "Category:Secretaries of state of Mississippi": "تصنيف:وزير خارجية مسيسيبي",
    "Category:Secretaries of state of Missouri": "تصنيف:وزير خارجية ميزوري",
    "Category:Secretaries of state of Montana": "تصنيف:وزير خارجية مونتانا",
    "Category:Secretaries of state of Nebraska": "تصنيف:وزير خارجية نبراسكا",
    "Category:Secretaries of state of Nevada": "تصنيف:وزير خارجية نيفادا",
    "Category:Secretaries of state of New Hampshire": "تصنيف:وزير خارجية نيوهامشير",
    "Category:Secretaries of state of New Jersey": "تصنيف:وزير خارجية نيوجيرسي",
    "Category:Secretaries of state of New York (state)": "تصنيف:وزير خارجية ولاية نيويورك",
    "Category:Secretaries of state of North Carolina": "تصنيف:وزير خارجية كارولاينا الشمالية",
    "Category:Secretaries of state of North Dakota": "تصنيف:وزراء خارجية داكوتا الشمالية",
    "Category:Secretaries of state of Ohio": "تصنيف:وزير خارجية أوهايو",
    "Category:Secretaries of state of Oklahoma": "تصنيف:وزير خارجية أوكلاهوما",
    "Category:Secretaries of state of Oregon": "تصنيف:وزير خارجية أوريغن",
    "Category:Secretaries of state of Rhode Island": "تصنيف:وزير خارجية رود آيلاند",
    "Category:Secretaries of state of South Carolina": "تصنيف:وزير خارجية كارولاينا الجنوبية",
    "Category:Secretaries of state of South Dakota": "تصنيف:وزير خارجية داكوتا الجنوبية",
    "Category:Secretaries of state of Tennessee": "تصنيف:وزير خارجية تينيسي",
    "Category:Secretaries of state of Texas": "تصنيف:وزير خارجية تكساس",
    "Category:Secretaries of state of Utah": "تصنيف:وزير خارجية يوتا",
    "Category:Secretaries of state of Vermont": "تصنيف:وزير خارجية فيرمونت",
    "Category:Secretaries of state of Washington (state)": "تصنيف:وزير خارجية ولاية واشنطن",
    "Category:Secretaries of state of West Virginia": "تصنيف:وزير خارجية فرجينيا الغربية",
    "Category:Secretaries of state of Wisconsin": "تصنيف:وزير خارجية ويسكونسن",
    "Category:Secretaries of state of Wyoming": "تصنيف:وزير خارجية وايومنغ",
    "Category:Secretaries of state of the Kingdom of England": "تصنيف:وزراء خارجية مملكة إنجلترا",
    "Category:Secretaries of the Australian Department of Defence": "تصنيف:وزراء في وزارة الدفاع الأسترالية",
    "Category:Secretaries of the Australian Department of Finance": "تصنيف:وزراء في وزارة المالية الأسترالية",
    ...
    "Category:Secretaries of war and navy of Colombia": "تصنيف:وزراء في الحرب وبحرية كولومبيا",
    ...
    "Category:State cabinet secretaries of Delaware": "تصنيف:أعضاء مجلس وزراء ديلوير",
    ...
    "Category:State cabinet secretaries of Minnesota": "تصنيف:أعضاء مجلس وزراء مينيسوتا",
    ...
    "Category:United States under secretaries of state": "تصنيف:الولايات المتحدة تحت وزير خارجية",
    "Category:Women secretaries of state of Mexico": "تصنيف:أمينات في ولاية مكسيكو",
    "Category:British secretaries of state": "تصنيف:وزراء دولة بريطانيون",
    ...
    "Category:Cardinal secretaries of state": "تصنيف:سكرتيرات الفاتيكان",
    ...
    "Category:United States assistant secretaries of state": "تصنيف:مساعدو وزير الخارجية الأمريكي",
...
@pytest.mark.parametrize("category,expected", secretaries_test_1.items(), ids=list(secretaries_test_1.keys()))
@pytest.mark.fast
