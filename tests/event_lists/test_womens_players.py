...
data1 = {
    "Category:Women's futsal players in Kuwait": "تصنيف:لاعبات كرة صالات نسائية في الكويت",
    "Category:Women's futsal players in the Maldives": "تصنيف:لاعبات كرة صالات نسائية في جزر المالديف",
    "Category:Women's field hockey players in England": "تصنيف:لاعبات هوكي ميدان نسائية في إنجلترا",
    "Category:Women's field hockey players in Ireland": "تصنيف:لاعبات هوكي ميدان نسائية في أيرلندا",
