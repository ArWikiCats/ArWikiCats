...
join_data_same = {
    ...
    "by american artists": "بواسطة فنانون أمريكيون",
    "by andy warhol": "بواسطة آندي وارهول",
    ...
    "universiade navigational boxes": "صناديق تصفح الألعاب الجامعية",
    ...
    "by hong kong producers": "بواسطة منتجون هونغ كونغيون",
    "by location and occupation": "حسب الموقع والمهنة",
    "by ludwig van beethoven": "بواسطة لودفيج فان بيتهوفن",
    ...
    "by robert louis stevenson": "بواسطة روبرت لويس ستيفنسون",
    ...
    "summer olympics navigational boxes": "صناديق تصفح الألعاب الأولمبية الصيفية",
    ...
    "mexican drama television series episodes": "حلقات مسلسلات تلفزيونية درامية مكسيكية",
