...
from ArWikiCats.legacy_bots.legacy_resolvers.ar_lab_bot import find_ar_label
from ArWikiCats.legacy_bots.legacy_resolvers.general_resolver import translate_general_category
