...
from ArWikiCats.legacy_bots.ma_bots.ar_lab_bot import find_ar_label
from ArWikiCats.legacy_bots.ma_bots.general_resolver import translate_general_category
