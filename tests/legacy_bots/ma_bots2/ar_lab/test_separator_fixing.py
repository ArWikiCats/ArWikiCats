...
from ArWikiCats.legacy_bots.ar_lab_bot import (
...
class TestSeparatorListsFixing:
    ...
    def test_skip_in_for_exception_types(self, monkeypatch: pytest.MonkeyPatch) -> None:
        ...
        monkeypatch.setattr(
            "ArWikiCats.legacy_bots.ar_lab_bot.keys_of_without_in",
            ["populations"],
            raising=False,
        )
...
class TestAddInTab:
    ...
    def test_add_من_for_of_suffix(self, monkeypatch: pytest.MonkeyPatch) -> None:
        ...
        monkeypatch.setattr(
            "ArWikiCats.legacy_bots.ar_lab_bot.get_pop_All_18",
            lambda *_: "some_value",
            raising=False,
        )
        monkeypatch.setattr(
            "ArWikiCats.legacy_bots.ar_lab_bot.check_key_new_players",
            lambda *_: True,
            raising=False,
        )
