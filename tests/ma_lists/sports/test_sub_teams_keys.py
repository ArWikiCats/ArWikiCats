...
"""
import pytest
from src.ma_lists.sports.sub_teams_keys import sub_teams_new
...
examples = {
    ...
    "men's youth wheelchair sprinting": "الجري السريع على الكراسي المتحركة للشباب",
    "men's youth wheelchair squash": "اسكواش على الكراسي المتحركة للشباب",
    "women's wheelchair marathon running": "سباق الماراثون على الكراسي المتحركة للسيدات",
    "women's wheelchair martial arts": "الفنون القتالية على الكراسي المتحركة للسيدات",
    "women's wheelchair middle-distance running": "ركض المسافات المتوسطة على الكراسي المتحركة للسيدات",
...
olympic_examples = {
    ...
    "wheelchair cross country running olympic champions": "أبطال عدو ريفي أولمبي على كراسي متحركة",
    "wheelchair cross country running olympic": "عدو ريفي أولمبي على كراسي متحركة",
    "wheelchair cross country running olympics": "عدو ريفي أولمبي على كراسي متحركة",
