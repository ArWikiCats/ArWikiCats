...
@pytest.mark.parametrize("category, expected", test_priffix.items(), ids=list(test_priffix.keys()))
@pytest.mark.fast
def test_work_mens_priffix(category: str, expected: str) -> None:
    label = work_mens_priffix(category)
    assert label == expected
