...
class TestSeparatorListsFixing:
    ...
    def test_add_في_with_in_separator(self):
    ...
    def test_no_change_when_in_not_in_type_lower(self):
        """Test that 'في' is not added when ' in' is not in type_lower."""
    ...
    def test_by_separator_returns_unchanged(self):
        """Test that 'by' separator doesn't add 'في'."""
        result = separator_lists_fixing("لوحات", "by", "paintings")
        assert result == "لوحات"

    def test_of_separator_returns_unchanged(self):
...
class TestAddInTab:
    ...
    def test_with_trailing_space_in_label(self):
...
class TestHelperFunctions:
    ...
    def test_should_add_preposition_في_true(self):
    ...
    def test_should_add_preposition_في_false_when_في_present(self):
    ...
    def test_should_add_preposition_في_false_when_no_in(self):
        """Test _should_add_preposition_في returns False when ' in' is not in type_lower."""
        assert _should_add_preposition_في("منشآت عسكرية", "military installations") is False
    ...
    def test_should_add_من_for_from_separator_false(self):
    ...
    def test_should_add_من_for_from_separator_with_spaces(self):
        """Test _should_add_من_for_from_separator handles trailing spaces."""
        assert _should_add_من_for_from_separator("رياضيون   ") is True

    def test_should_add_من_for_of_suffix_true(self):
    ...
    def test_should_add_من_for_of_suffix_false_no_ty_in18(self):
    ...
    def test_should_add_من_for_of_suffix_false_no_of(self):
    ...
    def test_should_add_من_for_of_suffix_false_في_present(self):
...
class TestEdgeCases:
    ...
    def test_separator_lists_fixing_empty_strings(self):
        """Test separator_lists_fixing with empty strings."""
        result = separator_lists_fixing("", "", "")
        assert result == ""

    def test_add_in_tab_empty_strings(self):
        """Test add_in_tab with empty strings."""
        result = add_in_tab("", "", "")
        assert result == ""

    def test_separator_lists_fixing_with_special_characters(self):
        """Test separator_lists_fixing with Arabic text containing special characters."""
        result = separator_lists_fixing("منشآت-عسكرية", "in", "military installations in")
        assert "في" in result

    def test_add_in_tab_with_multiple_spaces(self):
        """Test add_in_tab with multiple spaces in label."""
        result = add_in_tab("رياضيون    ", "athletes", "from")
        assert "من" in result

    def test_separator_lists_fixing_case_sensitivity(self):
