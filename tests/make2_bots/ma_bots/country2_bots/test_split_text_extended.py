...
data_of = {
    ...
    "economic history of united states": ("economic history of", "united states"),
    ...
    "history of american revolution": ("history of", "american revolution"),
    "history of austria hungary": ("history of", "austria hungary"),
    "history of central african republic": ("history of", "central african republic"),
    "history of copenhagen": ("history of", "copenhagen"),
    "history of united states": ("history of", "united states"),
    ...
    "political history of united states": ("political history of", "united states"),
