...
Work_US_State_data = {
    ...
    "oregon territory": "إقليم أوريغون",
    ...
    "oregon ballot measures": "إجراءات اقتراع أوريغون",
...
fast_data = {
    ...
    "west virginia politicians": "سياسيو فيرجينيا الغربية",
    "west virginia state court judges": "قضاة محكمة ولاية فيرجينيا الغربية",
    ...
    "oregon politicians": "سياسيو أوريغون",
    ...
    "minnesota legislature": "هيئة مينيسوتا التشريعية",
    ...
    "oregon legislative assembly": "هيئة أوريغون التشريعية",
    ...
    "west virginia legislature": "هيئة فيرجينيا الغربية التشريعية",
    ...
    "minnesota politicians": "سياسيو مينيسوتا",
    "minnesota state court judges": "قضاة محكمة ولاية مينيسوتا",
