...
data_to_fix2 = {
    ...
    "American black superhero television shows": "مسلسلات تلفزيونية سوداء أبطال خارقين أمريكية",
    ...
    "Indian superhero television shows": "مسلسلات تلفزيونية أبطال خارقين هندية",
    ...
    "LGBTQ-related superhero television shows": "مسلسلات تلفزيونية أبطال خارقين متعلقة بإل جي بي تي كيو",
    ...
    "Superhero horror television shows": "مسلسلات تلفزيونية أبطال خارقين رعب",
    "Superhero novels": "روايات أبطال خارقين",
    "Superhero science fiction web series": "سلاسل ويب أبطال خارقين خيال علمي",
    ...
    "Superhero television shows": "مسلسلات تلفزيونية أبطال خارقين",
    "Superhero thriller films": "أفلام أبطال خارقين إثارة",
    "Superhero video games": "ألعاب فيديو أبطال خارقين",
    "Superhero web series": "سلاسل ويب أبطال خارقين",
