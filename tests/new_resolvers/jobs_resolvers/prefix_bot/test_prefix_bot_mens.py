...
all_data = test_mens_data | test_suffix | test_prefix
...
TEMPORAL_CASES = [
    ...
    ("test_prefix_bot_mens_2", by_data_fast, mens_resolver_labels),
    ("test_prefix_bot_mens_3", test_suffix, mens_resolver_labels),
