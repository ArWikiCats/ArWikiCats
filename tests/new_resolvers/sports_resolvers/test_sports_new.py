...
data_1 = {
    ...
    "Women's sports seasons by continent": "مواسم رياضية نسائية حسب القارة",
    "Documentary films about women's sports": "أفلام وثائقية عن رياضية نسائية",
    "History of women's sports": "تاريخ رياضية نسائية",
    "Women's sports in the United States by state": "رياضية نسائية في الولايات المتحدة حسب الولاية",
    "Works about women's sports": "أعمال عن رياضية نسائية",
    ...
    "Women's sports in United States by state": "رياضية نسائية في الولايات المتحدة حسب الولاية",
