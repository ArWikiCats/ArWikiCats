...
test_data_standard = {
    ...
    "19th-century Jews from Ottoman Iraq": "يهود من العراق العثمانية في القرن 19",
    ...
    "19th-century rabbis from Ottoman Iraq": "حاخامات من العراق العثمانية في القرن 19",
...
def test_resolve_v3i_2(category: str, expected: str) -> None:
    """
    Test
    """
    result = resolve_year_job_from_countries(category)
